#!/bin/sh
# flash_OpenPod 1.4.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Tira o icone da tela Sobre o aparelho
#
...
#
# USO   sudo sh flash_OpenPod 1.4.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_OpenPod 1.4
LOG="$WORK/flash_OpenPod 1.4.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD 1.4   (4 setores, 16 KiB)"
log " 0x1A3000 +0x1000   <- OpenPod 1.4_1A3000.bin"
log " 0x10A000 +0x1000   <- OpenPod 1.4_10A000.bin"
log " 0x121000 +0x1000   <- OpenPod 1.4_121000.bin"
log " 0x122000 +0x1000   <- OpenPod 1.4_122000.bin"
...
ck_file OpenPod 1.4_1A3000.bin 6e8c70c8484972eddbd219e8fbb4e4091a47fabae8ca87348afcad9e282b976a
ck_file OpenPod 1.4_10A000.bin 5291ec1d41be051e8677023fed65e237d2dc030d375a7a77071b384b9d4c50bf
ck_file OpenPod 1.4_121000.bin 0a9a1c3e0f0bdd9e632e7fc222b7fd84e9b54a9bd4f69d2c4141284f91b5c83c
ck_file OpenPod 1.4_122000.bin 168e1ea8100caad9c3456cf5ac895a431e4bac831e069b1b85f18a9acc0657d5
...
log "   muda   : Tira o icone da tela Sobre o aparelho"
...
wr "4/6 1/4" 0x1A3000 OpenPod 1.4_1A3000.bin 6e8c70c8484972eddbd219e8fbb4e4091a47fabae8ca87348afcad9e282b976a
wr "4/6 2/4" 0x10A000 OpenPod 1.4_10A000.bin 5291ec1d41be051e8677023fed65e237d2dc030d375a7a77071b384b9d4c50bf
wr "4/6 3/4" 0x121000 OpenPod 1.4_121000.bin 0a9a1c3e0f0bdd9e632e7fc222b7fd84e9b54a9bd4f69d2c4141284f91b5c83c
wr "4/6 4/4" 0x122000 OpenPod 1.4_122000.bin 168e1ea8100caad9c3456cf5ac895a431e4bac831e069b1b85f18a9acc0657d5
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 3b8cd0d62a0f05daddaf3e93917bf68ff7d1178b130e0a8b1123f5330a5ce14a
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD 1.4 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_OpenPod 1.4.log"
log ""
