#!/bin/sh
# flash_OpenPod_Core_4.5.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# O voltar de um item do Extras retorna ao Extras
#
...
#
# USO   sudo sh flash_OpenPod_Core_4.5.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_4.5   (2 setores, 8 KiB)"
log " 0x10D000 +0x1000   <- OpenPod_Core_4.5_10D000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_Core_4.5_1A6000.bin"
...
ck_file "OpenPod_Core_4.5_10D000.bin" 6fe1812c1a69ae6e876e9fc7a63e10e83055850f60e209d3c0ed34a67231f40a
ck_file "OpenPod_Core_4.5_1A6000.bin" 09bfeb53729981b9329fa29bf4fcba4593a4185d7aa85dc84a067df597369dd7
...
log "   muda   : O voltar de um item do Extras retorna ao Extras"
...
wr "4/6 1/2" 0x10D000 "OpenPod_Core_4.5_10D000.bin" 6fe1812c1a69ae6e876e9fc7a63e10e83055850f60e209d3c0ed34a67231f40a
wr "4/6 2/2" 0x1A6000 "OpenPod_Core_4.5_1A6000.bin" 09bfeb53729981b9329fa29bf4fcba4593a4185d7aa85dc84a067df597369dd7
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_4.5 GRAVADO E VERIFICADO"
    log ""
