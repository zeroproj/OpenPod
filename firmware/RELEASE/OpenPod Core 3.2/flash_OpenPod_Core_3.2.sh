#!/bin/sh
# flash_OpenPod_Core_3.2.sh — OpenPod. GERADO por tools/make_install_kit.py.
...
#
# USO   sudo sh flash_OpenPod_Core_3.2.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_3.2   (3 setores, 12 KiB)"
log " 0x10A000 +0x1000   <- OpenPod_Core_3.2_10A000.bin"
log " 0x12E000 +0x1000   <- OpenPod_Core_3.2_12E000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_Core_3.2_1A6000.bin"
...
ck_file "OpenPod_Core_3.2_10A000.bin" e9d2846d56423cba6788ea4df5f9894a7e28661c5b7ca2159cc0a5756e626303
ck_file "OpenPod_Core_3.2_12E000.bin" 4063afee03977d472c69ada66f2adba6544326da8aa51cf9a0ead0613c1a7c8c
ck_file "OpenPod_Core_3.2_1A6000.bin" 71d2925ef8f0b0a505cb73ed97b7767c76391ea29bf887af98e2ef87489812b3
...
log "   muda   : Extras: os seis itens abrem as telas certas"
...
wr "4/6 1/3" 0x10A000 "OpenPod_Core_3.2_10A000.bin" e9d2846d56423cba6788ea4df5f9894a7e28661c5b7ca2159cc0a5756e626303
wr "4/6 2/3" 0x12E000 "OpenPod_Core_3.2_12E000.bin" 4063afee03977d472c69ada66f2adba6544326da8aa51cf9a0ead0613c1a7c8c
wr "4/6 3/3" 0x1A6000 "OpenPod_Core_3.2_1A6000.bin" 71d2925ef8f0b0a505cb73ed97b7767c76391ea29bf887af98e2ef87489812b3
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_3.2 GRAVADO E VERIFICADO"
    log ""
