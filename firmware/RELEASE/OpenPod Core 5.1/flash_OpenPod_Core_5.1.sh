#!/bin/sh
# flash_OpenPod_Core_5.1.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Pastas: monta o contexto do navegador antes de abrir
#
...
#
# USO   sudo sh flash_OpenPod_Core_5.1.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_5.1   (1 setores, 4 KiB)"
log " 0x1A6000 +0x1000   <- OpenPod_Core_5.1_1A6000.bin"
...
ck_file "OpenPod_Core_5.1_1A6000.bin" e29e98565d336d834ebabf5e90205c54a305ad2b3bbbcc2cc60ee087f8ce03a7
...
log "   muda   : Pastas: monta o contexto do navegador antes de abrir"
...
wr "4/6 1/1" 0x1A6000 "OpenPod_Core_5.1_1A6000.bin" e29e98565d336d834ebabf5e90205c54a305ad2b3bbbcc2cc60ee087f8ce03a7
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_5.1 GRAVADO E VERIFICADO"
    log ""
