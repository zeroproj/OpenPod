#!/bin/sh
# flash_OpenPod_DIAG2.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# DIAGNOSTICO 2: o pop devolve Configurar SEMPRE
#
...
#
# USO   sudo sh flash_OpenPod_DIAG2.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_DIAG2   (2 setores, 8 KiB)"
log " 0x10D000 +0x1000   <- OpenPod_DIAG2_10D000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_DIAG2_1A6000.bin"
...
ck_file "OpenPod_DIAG2_10D000.bin" fd84b5d227b4cb64d8b4c4272331e5872bda19124742871470f16706cf267347
ck_file "OpenPod_DIAG2_1A6000.bin" c96244539f79eebcde7d18f09b4ba7c47c8e2934ca3973370f2ef585329c2449
...
log "   muda   : DIAGNOSTICO 2: o pop devolve Configurar SEMPRE"
...
wr "4/6 1/2" 0x10D000 "OpenPod_DIAG2_10D000.bin" fd84b5d227b4cb64d8b4c4272331e5872bda19124742871470f16706cf267347
wr "4/6 2/2" 0x1A6000 "OpenPod_DIAG2_1A6000.bin" c96244539f79eebcde7d18f09b4ba7c47c8e2934ca3973370f2ef585329c2449
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 cbf92968680be512d6dcdcb7b7d8568ab29e1f3b1419b6e914f12f46f035595a
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_DIAG2 GRAVADO E VERIFICADO"
    log ""
