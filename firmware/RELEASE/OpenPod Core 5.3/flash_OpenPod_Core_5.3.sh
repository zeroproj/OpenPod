#!/bin/sh
# flash_OpenPod_Core_5.3.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# A casca da bateria ganha o prateado do Marte
#
...
#
# USO   sudo sh flash_OpenPod_Core_5.3.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_5.3   (2 setores, 8 KiB)"
log " 0x122000 +0x1000   <- OpenPod_Core_5.3_122000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_Core_5.3_1A6000.bin"
...
ck_file "OpenPod_Core_5.3_122000.bin" 905b4139f02cfe7de67a5dfc1fbd0e0c7085b3d3d4ea4ce44a4227c3b5497e80
ck_file "OpenPod_Core_5.3_1A6000.bin" 7f9ba1eaa80a0ff8169167cfc32654419febafc5eb3e5431e71465765a07d872
ck_file "base_122000.bin" e4c966686ef3208a5f20249baa89d8e9681da5cc709ba5a723d6a25926852509
ck_file "base_1A6000.bin" b6afca74edeb867f789c4af8a6a4a5575bd092655871cd65d8d25d5f4409984f
...
ck "FIRM" 57344 1647984 436e34892533a7df8b4a9e0a69ca0774910753682fea0bbf3ffe1b5efd935750
...
log "   muda   : A casca da bateria ganha o prateado do Marte"
...
wr "4/6 1/2" 0x122000 "OpenPod_Core_5.3_122000.bin" 905b4139f02cfe7de67a5dfc1fbd0e0c7085b3d3d4ea4ce44a4227c3b5497e80
wr "4/6 2/2" 0x1A6000 "OpenPod_Core_5.3_1A6000.bin" 7f9ba1eaa80a0ff8169167cfc32654419febafc5eb3e5431e71465765a07d872
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 a7d786e1c84d13323a5d3c5e5019f3cc795df70a40ce3bcd08461b08b1bc34df
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_5.3 GRAVADO E VERIFICADO"
    log ""
