#!/bin/sh
# flash_OpenPod_Core_3.9.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# EXPERIMENTO: so o Livro digital muda de mecanismo
#
...
#
# USO   sudo sh flash_OpenPod_Core_3.9.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_3.9   (1 setores, 4 KiB)"
log " 0x1A6000 +0x1000   <- OpenPod_Core_3.9_1A6000.bin"
...
ck_file "OpenPod_Core_3.9_1A6000.bin" 867bb7656842cb1550daeb93ffe0a22313534fbeea75cd1ebe72ed1f844e64d6
ck_file "base_1A6000.bin" 9b03e8650dc02d983e7a3b1d09ec15bdbde5b19c49625e6f70e829cbb4b47dd4
...
log "   muda   : EXPERIMENTO: so o Livro digital muda de mecanismo"
...
wr "4/6 1/1" 0x1A6000 "OpenPod_Core_3.9_1A6000.bin" 867bb7656842cb1550daeb93ffe0a22313534fbeea75cd1ebe72ed1f844e64d6
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_3.9 GRAVADO E VERIFICADO"
    log ""
