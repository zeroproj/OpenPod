#!/bin/sh
# flash_OpenPod_Core_5.7.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# O miolo da bateria fica verde-limao do Marte
#
...
#
# USO   sudo sh flash_OpenPod_Core_5.7.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_5.7   (2 setores, 8 KiB)"
log " 0x123000 +0x1000   <- OpenPod_Core_5.7_123000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_Core_5.7_1A6000.bin"
...
ck_file "OpenPod_Core_5.7_123000.bin" 213ef142bcbd7696faccc4e2139605cffda0d9f6e2bfbf0b368feca2fb2f0e50
ck_file "OpenPod_Core_5.7_1A6000.bin" 2aede3307c35b2428a1a0b3b35bddf2d13794f2b3f1db54d9ca866e38ef9e650
ck_file "base_123000.bin" ea26be22d36913fca1acb74850c4763f06f676464c803521bb53621390691eb0
ck_file "base_1A6000.bin" b7fdda1a27a06a883d4af227831fcf5ef1200b6b00fbc69a5b0dfabdbe0b1f8d
...
ck "FIRM" 57344 1647984 221fa8ea72220357f7ed5e3a192602caf33fff8aeacf42f900b1309c74613de3
...
log "   muda   : O miolo da bateria fica verde-limao do Marte"
...
wr "4/6 1/2" 0x123000 "OpenPod_Core_5.7_123000.bin" 213ef142bcbd7696faccc4e2139605cffda0d9f6e2bfbf0b368feca2fb2f0e50
wr "4/6 2/2" 0x1A6000 "OpenPod_Core_5.7_1A6000.bin" 2aede3307c35b2428a1a0b3b35bddf2d13794f2b3f1db54d9ca866e38ef9e650
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_5.7 GRAVADO E VERIFICADO"
    log ""
