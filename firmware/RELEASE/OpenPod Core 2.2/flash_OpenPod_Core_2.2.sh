#!/bin/sh
# flash_OpenPod_Core_2.2.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Sem traco entre os itens — a lista limpa do nano.
#
...
#
# USO   sudo sh flash_OpenPod_Core_2.2.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD CORE 2.2   (2 setores, 8 KiB)"
log " 0x121000 +0x1000   <- OpenPod_Core_2.2_121000.bin"
log " 0x1A4000 +0x1000   <- OpenPod_Core_2.2_1A4000.bin"
...
ck_file "OpenPod_Core_2.2_121000.bin" 36a53ea5ea3136036b03e029896623b40ad8afdd247955923ca9408f1817a6bc
ck_file "OpenPod_Core_2.2_1A4000.bin" f04979b73fae8809f4a7646adcc514e4fb9c49d7983b0c638c5583716a6bf9ab
ck_file "base_121000.bin" 0008e41e788a3a286501b33e99d93e8be8d9992a108f6c523b8add64e58a02a3
ck_file "base_1A4000.bin" 119a172090f024fc121e9582dd5516beabe6346b6720343cb6ad20b366f46298
...
ck "FIRM" 57344 1647984 4d30061107d818da82983612e700f2fdc2407f5f979241e6eb096bfd196e35f5
...
log "   muda   : Sem traco entre os itens — a lista limpa do nano."
...
wr "4/6 1/2" 0x121000 "OpenPod_Core_2.2_121000.bin" 36a53ea5ea3136036b03e029896623b40ad8afdd247955923ca9408f1817a6bc
wr "4/6 2/2" 0x1A4000 "OpenPod_Core_2.2_1A4000.bin" f04979b73fae8809f4a7646adcc514e4fb9c49d7983b0c638c5583716a6bf9ab
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 70c3ef827d1affa7eee097a077cb025ff3c807fada70f4310feb45f488638db2
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD CORE 2.2 GRAVADO E VERIFICADO"
    log ""
