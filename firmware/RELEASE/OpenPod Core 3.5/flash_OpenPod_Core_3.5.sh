#!/bin/sh
# flash_OpenPod_Core_3.5.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Extras: reaproveita a preparacao de fabrica de cada tela
#
...
#
# USO   sudo sh flash_OpenPod_Core_3.5.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_3.5   (3 setores, 12 KiB)"
log " 0x10A000 +0x1000   <- OpenPod_Core_3.5_10A000.bin"
log " 0x10C000 +0x1000   <- OpenPod_Core_3.5_10C000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_Core_3.5_1A6000.bin"
...
ck_file "OpenPod_Core_3.5_10A000.bin" 73f2086a22cb675eb3380bba04d05eceb96ce8532cc064f1cdb718285752be84
ck_file "OpenPod_Core_3.5_10C000.bin" 3b8683d363ba2d88fe25955572dfcb27a2153ec413f40a207ccf012d5e89b4d4
ck_file "OpenPod_Core_3.5_1A6000.bin" 1a304fb011e938500cfea3d5698529b5f3b0cfc144f51a7d04e92c5ff0671006
ck_file "base_10A000.bin" e9d2846d56423cba6788ea4df5f9894a7e28661c5b7ca2159cc0a5756e626303
ck_file "base_10C000.bin" da58ee1b07cc42893b98fb55a5248ac2ee4ee67a43b4bcd63b8651f25263441a
ck_file "base_1A6000.bin" 99cf4234353d2b9a92d5e0637ff828c759a161e5880fa178c77a86cc6d63bf95
...
ck "FIRM" 57344 1647984 1d78ef2142a02c44a88cbe99cea4a6a627310fa7fac73bb8ef6819165c8faa78
...
log "   muda   : Extras: reaproveita a preparacao de fabrica de cada tela"
...
wr "4/6 1/3" 0x10A000 "OpenPod_Core_3.5_10A000.bin" 73f2086a22cb675eb3380bba04d05eceb96ce8532cc064f1cdb718285752be84
wr "4/6 2/3" 0x10C000 "OpenPod_Core_3.5_10C000.bin" 3b8683d363ba2d88fe25955572dfcb27a2153ec413f40a207ccf012d5e89b4d4
wr "4/6 3/3" 0x1A6000 "OpenPod_Core_3.5_1A6000.bin" 1a304fb011e938500cfea3d5698529b5f3b0cfc144f51a7d04e92c5ff0671006
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 06a34b38fe06f352accc44bfc79413855d73891eb50d757352586f59bff260bd
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_3.5 GRAVADO E VERIFICADO"
    log ""
