#!/bin/sh
# flash_OpenPod_DIAG_pilha.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# DIAGNOSTICO: voltar com pilha vazia vai para Configurar
#
...
#
# USO   sudo sh flash_OpenPod_DIAG_pilha.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_DIAG_PILHA   (2 setores, 8 KiB)"
log " 0x10D000 +0x1000   <- OpenPod_DIAG_pilha_10D000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_DIAG_pilha_1A6000.bin"
...
ck_file "OpenPod_DIAG_pilha_10D000.bin" 4e81464dce3a139e6183e44078b29c703821eecf0dc64884c1334f8af80c4b7d
ck_file "OpenPod_DIAG_pilha_1A6000.bin" fa9c5ed1c3bc52bee3243baa5170e2492dcdac464d3aff89b0197f12193046f8
...
log "   muda   : DIAGNOSTICO: voltar com pilha vazia vai para Configurar"
...
wr "4/6 1/2" 0x10D000 "OpenPod_DIAG_pilha_10D000.bin" 4e81464dce3a139e6183e44078b29c703821eecf0dc64884c1334f8af80c4b7d
wr "4/6 2/2" 0x1A6000 "OpenPod_DIAG_pilha_1A6000.bin" fa9c5ed1c3bc52bee3243baa5170e2492dcdac464d3aff89b0197f12193046f8
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 5693ac745d1ffbda83fb5b2c52aa731250ff112249ac9088d449b8fe108fa12e
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_DIAG_PILHA GRAVADO E VERIFICADO"
    log ""
