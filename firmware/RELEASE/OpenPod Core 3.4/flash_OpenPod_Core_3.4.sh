#!/bin/sh
# flash_OpenPod_Core_3.4.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Extras: os seis destinos, na camada APP
#
...
#
# USO   sudo sh flash_OpenPod_Core_3.4.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_3.4   (3 setores, 12 KiB)"
log " 0x10A000 +0x1000   <- OpenPod_Core_3.4_10A000.bin"
log " 0x10C000 +0x1000   <- OpenPod_Core_3.4_10C000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_Core_3.4_1A6000.bin"
...
ck_file "OpenPod_Core_3.4_10A000.bin" 73f2086a22cb675eb3380bba04d05eceb96ce8532cc064f1cdb718285752be84
ck_file "OpenPod_Core_3.4_10C000.bin" 3b8683d363ba2d88fe25955572dfcb27a2153ec413f40a207ccf012d5e89b4d4
ck_file "OpenPod_Core_3.4_1A6000.bin" 617989f51e653b8963cd633504695750e5cdb783a036e0e923ac15cfb48217e8
...
log "   muda   : Extras: os seis destinos, na camada APP"
...
wr "4/6 1/3" 0x10A000 "OpenPod_Core_3.4_10A000.bin" 73f2086a22cb675eb3380bba04d05eceb96ce8532cc064f1cdb718285752be84
wr "4/6 2/3" 0x10C000 "OpenPod_Core_3.4_10C000.bin" 3b8683d363ba2d88fe25955572dfcb27a2153ec413f40a207ccf012d5e89b4d4
wr "4/6 3/3" 0x1A6000 "OpenPod_Core_3.4_1A6000.bin" 617989f51e653b8963cd633504695750e5cdb783a036e0e923ac15cfb48217e8
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_3.4 GRAVADO E VERIFICADO"
    log ""
