#!/bin/sh
# flash_OpenPod_Core_4.4.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# O voltar retorna ao Extras: empilha 0x53 na pilha de navegacao
#
...
#
# USO   sudo sh flash_OpenPod_Core_4.4.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_4.4   (2 setores, 8 KiB)"
log " 0x10A000 +0x1000   <- OpenPod_Core_4.4_10A000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_Core_4.4_1A6000.bin"
...
ck_file "OpenPod_Core_4.4_10A000.bin" 319f7d2d4ea9892cf3a3e40966431126404ca031c655b8e87198eabca27a40fb
ck_file "OpenPod_Core_4.4_1A6000.bin" ad1fe03450a4b0a1d1f65ad10c4b652246515f23f11733740f4c3b5a0e867139
ck_file "base_10A000.bin" 73f2086a22cb675eb3380bba04d05eceb96ce8532cc064f1cdb718285752be84
ck_file "base_1A6000.bin" 6f060240cd5ea624c78ec9e386d6615c3bef454020630e8af5735ca799e3aeba
...
ck "FIRM" 57344 1647984 6f676b662c83bc7cfa0feef50b049d3c851c5ad0087dca42231894588cf81d60
...
log "   muda   : O voltar retorna ao Extras: empilha 0x53 na pilha de navegacao"
...
wr "4/6 1/2" 0x10A000 "OpenPod_Core_4.4_10A000.bin" 319f7d2d4ea9892cf3a3e40966431126404ca031c655b8e87198eabca27a40fb
wr "4/6 2/2" 0x1A6000 "OpenPod_Core_4.4_1A6000.bin" ad1fe03450a4b0a1d1f65ad10c4b652246515f23f11733740f4c3b5a0e867139
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 a01260097163774f5f0358a80a66ded21fdea4b29d3fcbfdd295fab4190bb048
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_4.4 GRAVADO E VERIFICADO"
    log ""
