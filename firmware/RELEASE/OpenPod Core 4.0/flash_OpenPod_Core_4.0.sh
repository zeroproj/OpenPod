#!/bin/sh
# flash_OpenPod_Core_4.0.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Imagem recebe o mesmo tratamento do Livro digital
#
...
#
# USO   sudo sh flash_OpenPod_Core_4.0.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_4.0   (1 setores, 4 KiB)"
log " 0x1A6000 +0x1000   <- OpenPod_Core_4.0_1A6000.bin"
...
ck_file "OpenPod_Core_4.0_1A6000.bin" d842b3d45b208d3a4ab56298cdc73f7c4189c75ec0da3a72fdde2896f6976365
ck_file "base_1A6000.bin" 867bb7656842cb1550daeb93ffe0a22313534fbeea75cd1ebe72ed1f844e64d6
...
log "   muda   : Imagem recebe o mesmo tratamento do Livro digital"
...
wr "4/6 1/1" 0x1A6000 "OpenPod_Core_4.0_1A6000.bin" d842b3d45b208d3a4ab56298cdc73f7c4189c75ec0da3a72fdde2896f6976365
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_4.0 GRAVADO E VERIFICADO"
    log ""
