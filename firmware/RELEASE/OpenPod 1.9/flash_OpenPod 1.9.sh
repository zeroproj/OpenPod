#!/bin/sh
# flash_OpenPod 1.9.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Texto branco nas listas + respiro sob a faixa superior
#
...
#
# USO   sudo sh flash_OpenPod 1.9.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_OpenPod 1.9
LOG="$WORK/flash_OpenPod 1.9.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD 1.9   (3 setores, 12 KiB)"
log " 0x1A5000 +0x1000   <- OpenPod 1.9_1A5000.bin"
log " 0x10A000 +0x1000   <- OpenPod 1.9_10A000.bin"
log " 0x121000 +0x1000   <- OpenPod 1.9_121000.bin"
...
ck_file OpenPod 1.9_1A5000.bin 3ebab7028a497f355f330cb49ce4d060f7612a84cbdff7a52afa4420d4455acf
ck_file OpenPod 1.9_10A000.bin 7b43b61a034b566e9af5321434b542d36e8336e451f184ef56f19ed8c8d92767
ck_file OpenPod 1.9_121000.bin 6a86e47e0a38da870cdd7acf125a388c40b7e464720dc29bf8b32858eb0ce5be
ck_file base_1A5000.bin ce68c40c702251c776294f04aeec42b04dade2acdb1a11c023fddb06139da998
ck_file base_10A000.bin 655414200445b89ac4b2a571eee6ff7e238474f9a59bc46989a16fe9ef67dbc4
ck_file base_121000.bin 635a1cfce5a14694699bf1dcb0eb0bfc74c8210de63be2a1c591e9b75596925e
...
ck "FIRM" 57344 1647984 a2e96fc4539ec540b985cce48ae0c45a328cfb217212a0a26237f550048a70a6
...
log "   muda   : Texto branco nas listas + respiro sob a faixa superior"
...
wr "4/6 1/3" 0x1A5000 OpenPod 1.9_1A5000.bin 3ebab7028a497f355f330cb49ce4d060f7612a84cbdff7a52afa4420d4455acf
wr "4/6 2/3" 0x10A000 OpenPod 1.9_10A000.bin 7b43b61a034b566e9af5321434b542d36e8336e451f184ef56f19ed8c8d92767
wr "4/6 3/3" 0x121000 OpenPod 1.9_121000.bin 6a86e47e0a38da870cdd7acf125a388c40b7e464720dc29bf8b32858eb0ce5be
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 1acb506ba4f680f33a0d894f38de374198136d742c39cc2957e3c7cb9ddeb908
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD 1.9 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_OpenPod 1.9.log"
log ""
