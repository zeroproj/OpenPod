#!/bin/sh
# flash_OpenPod_Core_1.0.1.sh — OpenPod. GERADO por tools/make_install_kit.py.
...
#
# USO   sudo sh flash_OpenPod_Core_1.0.1.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD CORE 1.0.1   (2 setores, 8 KiB)"
log " 0x122000 +0x1000   <- OpenPod_Core_1.0.1_122000.bin"
log " 0x1A4000 +0x1000   <- OpenPod_Core_1.0.1_1A4000.bin"
...
ck_file "OpenPod_Core_1.0.1_122000.bin" 23d44d20cd914ab860eedd25f938eece99af4a059e8e229b3a33e6195fef06ac
ck_file "OpenPod_Core_1.0.1_1A4000.bin" 1e9d3b128b55dbada2d51ce0ce01365fd23126f5be34629626825d333cffdec0
ck_file "base_122000.bin" dc3b6a4a0150763564474047400cebac7b4e331820901505eacf3644083c7c48
ck_file "base_1A4000.bin" eaa94bfe5d728697d74a3cff501b1068db3fe7fdbc8af02a50c6370d14ca82f7
...
ck "FIRM" 57344 1647984 c4495f5ed529286a219d99a83017b11f17b636a797060e325a835bccbfcbd1ad
...
log "   muda   : Correcao da 1.0: fundo da abertura preto, tela Informacoes numa linha."
...
wr "4/6 1/2" 0x122000 "OpenPod_Core_1.0.1_122000.bin" 23d44d20cd914ab860eedd25f938eece99af4a059e8e229b3a33e6195fef06ac
wr "4/6 2/2" 0x1A4000 "OpenPod_Core_1.0.1_1A4000.bin" 1e9d3b128b55dbada2d51ce0ce01365fd23126f5be34629626825d333cffdec0
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 a97035e918938668fef304a37037900645d8c0e1bacb22360ed5ce8157a3e7e4
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD CORE 1.0.1 GRAVADO E VERIFICADO"
    log ""
