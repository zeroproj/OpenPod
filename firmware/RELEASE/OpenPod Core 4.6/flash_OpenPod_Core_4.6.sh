#!/bin/sh
# flash_OpenPod_Core_4.6.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Voltar retorna ao Extras. Corrige o epilogo que travou a 4.5
#
...
#
# USO   sudo sh flash_OpenPod_Core_4.6.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_4.6   (2 setores, 8 KiB)"
log " 0x10D000 +0x1000   <- OpenPod_Core_4.6_10D000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_Core_4.6_1A6000.bin"
...
ck_file "OpenPod_Core_4.6_10D000.bin" 6fe1812c1a69ae6e876e9fc7a63e10e83055850f60e209d3c0ed34a67231f40a
ck_file "OpenPod_Core_4.6_1A6000.bin" 954a4e88d1b9cf59101c173beda0495c3e9eb8fd0f3dcf2817bddf5f0891fce0
...
log "   muda   : Voltar retorna ao Extras. Corrige o epilogo que travou a 4.5"
...
wr "4/6 1/2" 0x10D000 "OpenPod_Core_4.6_10D000.bin" 6fe1812c1a69ae6e876e9fc7a63e10e83055850f60e209d3c0ed34a67231f40a
wr "4/6 2/2" 0x1A6000 "OpenPod_Core_4.6_1A6000.bin" 954a4e88d1b9cf59101c173beda0495c3e9eb8fd0f3dcf2817bddf5f0891fce0
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 9ed43b6a85cabc1ec481f5f9b3aac63d4d59539289587e090a711eb813f20efd
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_4.6 GRAVADO E VERIFICADO"
    log ""
