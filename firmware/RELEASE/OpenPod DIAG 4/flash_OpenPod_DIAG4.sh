#!/bin/sh
# flash_OpenPod_DIAG4.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# DIAGNOSTICO 4: o push do roteador chega a executar?
#
...
#
# USO   sudo sh flash_OpenPod_DIAG4.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_DIAG4   (1 setores, 4 KiB)"
log " 0x1A6000 +0x1000   <- OpenPod_DIAG4_1A6000.bin"
...
ck_file "OpenPod_DIAG4_1A6000.bin" db94c269ed978fc7bc778d3cb32baa8ee1385c5610ee1c8f3361f6785757da8b
...
log "   muda   : DIAGNOSTICO 4: o push do roteador chega a executar?"
...
wr "4/6 1/1" 0x1A6000 "OpenPod_DIAG4_1A6000.bin" db94c269ed978fc7bc778d3cb32baa8ee1385c5610ee1c8f3361f6785757da8b
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_DIAG4 GRAVADO E VERIFICADO"
    log ""
