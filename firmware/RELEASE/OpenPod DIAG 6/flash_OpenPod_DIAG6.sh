#!/bin/sh
# flash_OpenPod_DIAG6.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# DIAG 6: o indice 3 abre o Extras
#
...
#
# USO   sudo sh flash_OpenPod_DIAG6.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_DIAG6   (2 setores, 8 KiB)"
log " 0x101000 +0x1000   <- OpenPod_DIAG6_101000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_DIAG6_1A6000.bin"
...
ck_file "OpenPod_DIAG6_101000.bin" 061d7ee45708dbd5aef53732f256e515235f66d438ea13972547498c65ee82bc
ck_file "OpenPod_DIAG6_1A6000.bin" 9e33b5da1dc95cf2aaf7ec259dd516a36e53980d493bc488ecb56d73d2cd753c
ck_file "base_101000.bin" 1ef770d13b9d0807ac21c4256adfac0fefd88dc4f4550b2ec65a350b42686081
ck_file "base_1A6000.bin" 22ab05bbfd42288bcc0324d532937d92e50ee4c8a0d4dd8187e4b18826d1fd3c
...
ck "FIRM" 57344 1647984 9f0ee94963a8c7ad90c32a0be5d65a34f661da6513db550d2927a0ccca104360
...
log "   muda   : DIAG 6: o indice 3 abre o Extras"
...
wr "4/6 1/2" 0x101000 "OpenPod_DIAG6_101000.bin" 061d7ee45708dbd5aef53732f256e515235f66d438ea13972547498c65ee82bc
wr "4/6 2/2" 0x1A6000 "OpenPod_DIAG6_1A6000.bin" 9e33b5da1dc95cf2aaf7ec259dd516a36e53980d493bc488ecb56d73d2cd753c
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 279c5ac4e4328703fc6a43c5f1dd6509d6461d8937cacd4fb430b45fd72a33d4
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_DIAG6 GRAVADO E VERIFICADO"
    log ""
