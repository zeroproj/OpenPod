#!/bin/sh
# flash_OpenPod_Core_3.3.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Extras: a cadeia de comparacao vai de 3 para 6 elos. Metade LVGL apenas.
#
...
#
# USO   sudo sh flash_OpenPod_Core_3.3.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_3.3   (3 setores, 12 KiB)"
log " 0x10A000 +0x1000   <- OpenPod_Core_3.3_10A000.bin"
log " 0x12E000 +0x1000   <- OpenPod_Core_3.3_12E000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_Core_3.3_1A6000.bin"
...
ck_file "OpenPod_Core_3.3_10A000.bin" e9d2846d56423cba6788ea4df5f9894a7e28661c5b7ca2159cc0a5756e626303
ck_file "OpenPod_Core_3.3_12E000.bin" 4063afee03977d472c69ada66f2adba6544326da8aa51cf9a0ead0613c1a7c8c
ck_file "OpenPod_Core_3.3_1A6000.bin" 99cf4234353d2b9a92d5e0637ff828c759a161e5880fa178c77a86cc6d63bf95
ck_file "base_10A000.bin" 8c35d232644fbcec0e57519558b61e1d3f0a7b0d269bbadde0c4eae6ba5316d3
ck_file "base_12E000.bin" 011f0b4f195b334d84688731efec043a283888a75f54981b848f07c0bbc4d9fd
...
ck "FIRM" 57344 1647984 cfa71dc1f1c6b48d268573847e3df1fccbdd287a31d5f871801f52d9acc4034f
...
log "   muda   : Extras: a cadeia de comparacao vai de 3 para 6 elos. Metade LVGL apenas."
...
wr "4/6 1/3" 0x10A000 "OpenPod_Core_3.3_10A000.bin" e9d2846d56423cba6788ea4df5f9894a7e28661c5b7ca2159cc0a5756e626303
wr "4/6 2/3" 0x12E000 "OpenPod_Core_3.3_12E000.bin" 4063afee03977d472c69ada66f2adba6544326da8aa51cf9a0ead0613c1a7c8c
wr "4/6 3/3" 0x1A6000 "OpenPod_Core_3.3_1A6000.bin" 99cf4234353d2b9a92d5e0637ff828c759a161e5880fa178c77a86cc6d63bf95
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 1d78ef2142a02c44a88cbe99cea4a6a627310fa7fac73bb8ef6819165c8faa78
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_3.3 GRAVADO E VERIFICADO"
    log ""
