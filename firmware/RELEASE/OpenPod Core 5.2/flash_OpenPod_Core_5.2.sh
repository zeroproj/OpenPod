#!/bin/sh
# flash_OpenPod_Core_5.2.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# A barra da bateria ganha o verde do Marte
#
...
#
# USO   sudo sh flash_OpenPod_Core_5.2.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_5.2   (2 setores, 8 KiB)"
log " 0x122000 +0x1000   <- OpenPod_Core_5.2_122000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_Core_5.2_1A6000.bin"
...
ck_file "OpenPod_Core_5.2_122000.bin" e4c966686ef3208a5f20249baa89d8e9681da5cc709ba5a723d6a25926852509
ck_file "OpenPod_Core_5.2_1A6000.bin" b6afca74edeb867f789c4af8a6a4a5575bd092655871cd65d8d25d5f4409984f
ck_file "base_122000.bin" 3f2b04dd4890e0c8416725b74ff9894657528f17db02068a3a5b1a70343b97d5
ck_file "base_1A6000.bin" e29e98565d336d834ebabf5e90205c54a305ad2b3bbbcc2cc60ee087f8ce03a7
...
ck "FIRM" 57344 1647984 b54a9d88b3022692a6dc9a42bf237c81bc5316278e2df28da507871993ef7461
...
log "   muda   : A barra da bateria ganha o verde do Marte"
...
wr "4/6 1/2" 0x122000 "OpenPod_Core_5.2_122000.bin" e4c966686ef3208a5f20249baa89d8e9681da5cc709ba5a723d6a25926852509
wr "4/6 2/2" 0x1A6000 "OpenPod_Core_5.2_1A6000.bin" b6afca74edeb867f789c4af8a6a4a5575bd092655871cd65d8d25d5f4409984f
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 436e34892533a7df8b4a9e0a69ca0774910753682fea0bbf3ffe1b5efd935750
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_5.2 GRAVADO E VERIFICADO"
    log ""
