#!/bin/sh
# flash_OpenPod_Core_3.8.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Imagem e Livro digital: replica exata da cauda de fabrica
#
...
#
# USO   sudo sh flash_OpenPod_Core_3.8.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_3.8   (2 setores, 8 KiB)"
log " 0x10A000 +0x1000   <- OpenPod_Core_3.8_10A000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_Core_3.8_1A6000.bin"
...
ck_file "OpenPod_Core_3.8_10A000.bin" f5efc41d807ada4201b244207e7ae107a1e6b854cb7f133a61964fdaded41903
ck_file "OpenPod_Core_3.8_1A6000.bin" 4c6f5a9a53be4ea76e151fbfcbe733958076c10e2e6a678892b1047ba6e77365
ck_file "base_10A000.bin" 73f2086a22cb675eb3380bba04d05eceb96ce8532cc064f1cdb718285752be84
ck_file "base_1A6000.bin" 6369b531982967946f84825bd9370da6d7a297fab6c15a37ab61be52b9a914ec
...
log "   muda   : Imagem e Livro digital: replica exata da cauda de fabrica"
...
wr "4/6 1/2" 0x10A000 "OpenPod_Core_3.8_10A000.bin" f5efc41d807ada4201b244207e7ae107a1e6b854cb7f133a61964fdaded41903
wr "4/6 2/2" 0x1A6000 "OpenPod_Core_3.8_1A6000.bin" 4c6f5a9a53be4ea76e151fbfcbe733958076c10e2e6a678892b1047ba6e77365
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 dcb198e7a3bf55587cc012ce9b9a531ba5731e3057195ef3bb67ba4864a54741
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_3.8 GRAVADO E VERIFICADO"
    log ""
