#!/bin/sh
# flash_OpenPod_DIAG3.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# DIAGNOSTICO 3: revela o topo da pilha no voltar
#
...
#
# USO   sudo sh flash_OpenPod_DIAG3.sh [/opt/smartlink_flash]
...
die() {
    ...
    if [ "$WROTE" -ne 0 ]; then
        ...
        log "***   sudo $TOOL --id $DEV write_flash 0x10E000 0 0x1000 base_10E000.bin"
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_DIAG3   (2 setores, 8 KiB)"
log " 0x10E000 +0x1000   <- OpenPod_DIAG3_10E000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_DIAG3_1A6000.bin"
...
ck_file "OpenPod_DIAG3_10E000.bin" 4a62d1ceafa3945fcf8a4cac981edd0c3ffaed759674574af3f1043fb3ccdf15
ck_file "OpenPod_DIAG3_1A6000.bin" 08e797658138421fc439495841292bc8f56d1927a543c0dd71e3a04c69e225f5
ck_file "base_10E000.bin" 73116ac14f2d91de62a97a5335c736c522c3411d0abf6edf74e1d25de3bd9d9b
ck_file "base_1A6000.bin" ad1fe03450a4b0a1d1f65ad10c4b652246515f23f11733740f4c3b5a0e867139
...
ck "FIRM" 57344 1647984 a01260097163774f5f0358a80a66ded21fdea4b29d3fcbfdd295fab4190bb048
...
log "   muda   : DIAGNOSTICO 3: revela o topo da pilha no voltar"
...
wr "4/6 1/2" 0x10E000 "OpenPod_DIAG3_10E000.bin" 4a62d1ceafa3945fcf8a4cac981edd0c3ffaed759674574af3f1043fb3ccdf15
wr "4/6 2/2" 0x1A6000 "OpenPod_DIAG3_1A6000.bin" 08e797658138421fc439495841292bc8f56d1927a543c0dd71e3a04c69e225f5
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 cb073e218334fc1fb324cca97c8f14ab0a0e125eb5fc090ba8d79096917bc97a
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_DIAG3 GRAVADO E VERIFICADO"
    log ""
