#!/bin/sh
# flash_OpenPod_Core_4.3.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Pastas: replica do caso de fabrica, com o contexto do navegador
#
...
#
# USO   sudo sh flash_OpenPod_Core_4.3.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_4.3   (2 setores, 8 KiB)"
log " 0x10A000 +0x1000   <- OpenPod_Core_4.3_10A000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_Core_4.3_1A6000.bin"
...
ck_file "OpenPod_Core_4.3_10A000.bin" 319f7d2d4ea9892cf3a3e40966431126404ca031c655b8e87198eabca27a40fb
ck_file "OpenPod_Core_4.3_1A6000.bin" b2c087dd2cfa737911ecf2ece85cba4ae30d30cb643b7864cb3cf64197c25b3a
...
log "   muda   : Pastas: replica do caso de fabrica, com o contexto do navegador"
...
wr "4/6 1/2" 0x10A000 "OpenPod_Core_4.3_10A000.bin" 319f7d2d4ea9892cf3a3e40966431126404ca031c655b8e87198eabca27a40fb
wr "4/6 2/2" 0x1A6000 "OpenPod_Core_4.3_1A6000.bin" b2c087dd2cfa737911ecf2ece85cba4ae30d30cb643b7864cb3cf64197c25b3a
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_4.3 GRAVADO E VERIFICADO"
    log ""
