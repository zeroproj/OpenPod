#!/bin/sh
# flash_OpenPod_DIAG7.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# DIAG 7: pagina 0x28 com sub 0
#
...
#
# USO   sudo sh flash_OpenPod_DIAG7.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_DIAG7   (2 setores, 8 KiB)"
log " 0x101000 +0x1000   <- OpenPod_DIAG7_101000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_DIAG7_1A6000.bin"
...
ck_file "OpenPod_DIAG7_101000.bin" 673da19a6d3d37b673316192ec95fab51e36ae91df6e3d1c0f72e560635d94eb
ck_file "OpenPod_DIAG7_1A6000.bin" d3e64950120ab5f89691d83a69684fd2f58f2a17999114b7e2623fdfff74437a
ck_file "base_101000.bin" 061d7ee45708dbd5aef53732f256e515235f66d438ea13972547498c65ee82bc
ck_file "base_1A6000.bin" 9e33b5da1dc95cf2aaf7ec259dd516a36e53980d493bc488ecb56d73d2cd753c
...
ck "FIRM" 57344 1647984 279c5ac4e4328703fc6a43c5f1dd6509d6461d8937cacd4fb430b45fd72a33d4
...
log "   muda   : DIAG 7: pagina 0x28 com sub 0"
...
wr "4/6 1/2" 0x101000 "OpenPod_DIAG7_101000.bin" 673da19a6d3d37b673316192ec95fab51e36ae91df6e3d1c0f72e560635d94eb
wr "4/6 2/2" 0x1A6000 "OpenPod_DIAG7_1A6000.bin" d3e64950120ab5f89691d83a69684fd2f58f2a17999114b7e2623fdfff74437a
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 b54a9d88b3022692a6dc9a42bf237c81bc5316278e2df28da507871993ef7461
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_DIAG7 GRAVADO E VERIFICADO"
    log ""
