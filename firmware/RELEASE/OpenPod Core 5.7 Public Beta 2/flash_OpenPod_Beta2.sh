...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_BETA2   (44 setores, 176 KiB)"
...
log "   muda   : OpenPod 5.7 Public Beta 2"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_BETA2 GRAVADO E VERIFICADO"
    log ""
