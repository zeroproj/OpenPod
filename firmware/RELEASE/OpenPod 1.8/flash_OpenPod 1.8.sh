#!/bin/sh
# flash_OpenPod 1.8.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Reverte a navegacao para o padrao do produto
#
...
#
# USO   sudo sh flash_OpenPod 1.8.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_OpenPod 1.8
LOG="$WORK/flash_OpenPod 1.8.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD 1.8   (3 setores, 12 KiB)"
log " 0x147000 +0x1000   <- OpenPod 1.8_147000.bin"
log " 0x10A000 +0x1000   <- OpenPod 1.8_10A000.bin"
log " 0x1A5000 +0x1000   <- OpenPod 1.8_1A5000.bin"
...
ck_file OpenPod 1.8_147000.bin 685f1aa127b3997c4052a52b904f2c9c927dc717c1d75caaa34c474dc4657887
ck_file OpenPod 1.8_10A000.bin 655414200445b89ac4b2a571eee6ff7e238474f9a59bc46989a16fe9ef67dbc4
ck_file OpenPod 1.8_1A5000.bin ce68c40c702251c776294f04aeec42b04dade2acdb1a11c023fddb06139da998
ck_file base_147000.bin 453df7b12745c56408119e5da039f5ee5a7665ab26df95aae8a77f6b3d15c305
ck_file base_10A000.bin 86bdec86749947b3f4d7ed01831068bd1558996a17ff008d6411c206b837181b
ck_file base_1A5000.bin d9e49226a07c887194a031d043634b486b9625eff696782511ef0a15df14b60f
...
ck "FIRM" 57344 1647984 02b3741a906cb1b590d2540a5c5e07751ef1df7fd1c56b0dadfd6cc791664cc1
...
log "   muda   : Reverte a navegacao para o padrao do produto"
...
wr "4/6 1/3" 0x147000 OpenPod 1.8_147000.bin 685f1aa127b3997c4052a52b904f2c9c927dc717c1d75caaa34c474dc4657887
wr "4/6 2/3" 0x10A000 OpenPod 1.8_10A000.bin 655414200445b89ac4b2a571eee6ff7e238474f9a59bc46989a16fe9ef67dbc4
wr "4/6 3/3" 0x1A5000 OpenPod 1.8_1A5000.bin ce68c40c702251c776294f04aeec42b04dade2acdb1a11c023fddb06139da998
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD 1.8 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_OpenPod 1.8.log"
log ""
