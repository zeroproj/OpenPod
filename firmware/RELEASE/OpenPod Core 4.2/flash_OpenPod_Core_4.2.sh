#!/bin/sh
# flash_OpenPod_Core_4.2.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Imagem: replica com a origem vinda da mensagem
#
...
#
# USO   sudo sh flash_OpenPod_Core_4.2.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_4.2   (1 setores, 4 KiB)"
log " 0x1A6000 +0x1000   <- OpenPod_Core_4.2_1A6000.bin"
...
ck_file "OpenPod_Core_4.2_1A6000.bin" 6f060240cd5ea624c78ec9e386d6615c3bef454020630e8af5735ca799e3aeba
ck_file "base_1A6000.bin" ba4a5735df6743a66b87ff2111cfde84adc6738656942db1ae990f5932788a97
...
log "   muda   : Imagem: replica com a origem vinda da mensagem"
...
wr "4/6 1/1" 0x1A6000 "OpenPod_Core_4.2_1A6000.bin" 6f060240cd5ea624c78ec9e386d6615c3bef454020630e8af5735ca799e3aeba
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_4.2 GRAVADO E VERIFICADO"
    log ""
