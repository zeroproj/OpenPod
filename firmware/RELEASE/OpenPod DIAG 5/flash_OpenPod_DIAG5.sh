#!/bin/sh
# flash_OpenPod_DIAG5.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# DIAGNOSTICO 5: toda empilhada vira Extras
#
...
#
# USO   sudo sh flash_OpenPod_DIAG5.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_DIAG5   (2 setores, 8 KiB)"
log " 0x10D000 +0x1000   <- OpenPod_DIAG5_10D000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_DIAG5_1A6000.bin"
...
ck_file "OpenPod_DIAG5_10D000.bin" 3d46d1e788e7c942ca2ccd4b57c5af1573836d3215307fd603074f218d7c1be8
ck_file "OpenPod_DIAG5_1A6000.bin" 91fe4bbe178fefe90e023ba6b5b9c4fbd06b5313d9c1cd7d8c3d5d01e7db286b
...
log "   muda   : DIAGNOSTICO 5: toda empilhada vira Extras"
...
wr "4/6 1/2" 0x10D000 "OpenPod_DIAG5_10D000.bin" 3d46d1e788e7c942ca2ccd4b57c5af1573836d3215307fd603074f218d7c1be8
wr "4/6 2/2" 0x1A6000 "OpenPod_DIAG5_1A6000.bin" 91fe4bbe178fefe90e023ba6b5b9c4fbd06b5313d9c1cd7d8c3d5d01e7db286b
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 cfa2e8bedda7ffcc985b7a0bbf25e19b570db16e1d8f5a551a1ce179116a0fd7
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_DIAG5 GRAVADO E VERIFICADO"
    log ""
