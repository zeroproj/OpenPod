#!/bin/sh
# flash_OpenPod_Core_5.6.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# A casca da bateria prateada nos quatro sitios seguros
#
...
#
# USO   sudo sh flash_OpenPod_Core_5.6.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_5.6   (2 setores, 8 KiB)"
log " 0x123000 +0x1000   <- OpenPod_Core_5.6_123000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_Core_5.6_1A6000.bin"
...
ck_file "OpenPod_Core_5.6_123000.bin" 5ebf661547a6485b83937f5c6abc9f618300033847a03542be50621e7c29358f
ck_file "OpenPod_Core_5.6_1A6000.bin" 798874692c728fc51d415bcd86abf3edaae64ef91df1d5b829165745784d90a8
ck_file "base_123000.bin" a5e933f8bd1ff585643fbc626d072b1e54444a8556b9c3c3ad78c4a51fd13dc4
ck_file "base_1A6000.bin" 0d5614a8668bcf00af442a70dce9ea00fca027f06cb0c8b9112f9197a1d7cab4
...
ck "FIRM" 57344 1647984 3586c0d6464fe562b8ddaacceb259991518d6840cf89b3d15ec665277eb58d1c
...
log "   muda   : A casca da bateria prateada nos quatro sitios seguros"
...
wr "4/6 1/2" 0x123000 "OpenPod_Core_5.6_123000.bin" 5ebf661547a6485b83937f5c6abc9f618300033847a03542be50621e7c29358f
wr "4/6 2/2" 0x1A6000 "OpenPod_Core_5.6_1A6000.bin" 798874692c728fc51d415bcd86abf3edaae64ef91df1d5b829165745784d90a8
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 490e6a7d400336d7cfc190a3e0c58063bd51f4e1df9e8a4ef7c0a3fb64c7b393
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_5.6 GRAVADO E VERIFICADO"
    log ""
