#!/bin/sh
# flash_OpenPod_Core_5.0.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Home com quatro itens: Musica, Video, Extras, Configurar
#
# Grava 1 setores de 4096 B (4 KiB). O bootloader (0x0..0xD000)
# nao e endereçado. write_flash sempre com 0 no 2o argumento, a
# partir de um arquivo por setor (docs/WRITE_FLASH_SEMANTICS.md).
#
# USO   sudo sh flash_OpenPod_Core_5.0.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_5.0   (1 setores, 4 KiB)"
log " 0x1A6000 +0x1000   <- OpenPod_Core_5.0_1A6000.bin"
...
ck_file "OpenPod_Core_5.0_1A6000.bin" ec4aab13e48f1f4dae247df82f7f5fb565e817d49e47a01d6da2396056130323
ck_file "base_1A6000.bin" d3e64950120ab5f89691d83a69684fd2f58f2a17999114b7e2623fdfff74437a
...
log "   grava  : 4 KiB em 1 setores"
log "   muda   : Home com quatro itens: Musica, Video, Extras, Configurar"
...
wr "4/6 1/1" 0x1A6000 "OpenPod_Core_5.0_1A6000.bin" ec4aab13e48f1f4dae247df82f7f5fb565e817d49e47a01d6da2396056130323
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_5.0 GRAVADO E VERIFICADO"
    log ""
