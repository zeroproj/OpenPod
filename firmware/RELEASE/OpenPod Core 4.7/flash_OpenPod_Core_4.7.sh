#!/bin/sh
# flash_OpenPod_Core_4.7.sh — OpenPod. GERADO por tools/make_install_kit.py.
...
#
# USO   sudo sh flash_OpenPod_Core_4.7.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_4.7   (2 setores, 8 KiB)"
log " 0x12E000 +0x1000   <- OpenPod_Core_4.7_12E000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_Core_4.7_1A6000.bin"
...
ck_file "OpenPod_Core_4.7_12E000.bin" 20d7b2df3e31e784319e553a2734bd1dfadff664a304037baf02cd4fc1a49af7
ck_file "OpenPod_Core_4.7_1A6000.bin" 2f2f781998aabbd24c8b6041dbace739a396707eff34d1ff930ae03461513951
ck_file "base_12E000.bin" 4063afee03977d472c69ada66f2adba6544326da8aa51cf9a0ead0613c1a7c8c
ck_file "base_1A6000.bin" 954a4e88d1b9cf59101c173beda0495c3e9eb8fd0f3dcf2817bddf5f0891fce0
...
ck "FIRM" 57344 1647984 9ed43b6a85cabc1ec481f5f9b3aac63d4d59539289587e090a711eb813f20efd
...
log "   muda   : M e VOL ficam inertes na tela inicial"
...
wr "4/6 1/2" 0x12E000 "OpenPod_Core_4.7_12E000.bin" 20d7b2df3e31e784319e553a2734bd1dfadff664a304037baf02cd4fc1a49af7
wr "4/6 2/2" 0x1A6000 "OpenPod_Core_4.7_1A6000.bin" 2f2f781998aabbd24c8b6041dbace739a396707eff34d1ff930ae03461513951
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 5b40912e6dd0aecab77ad21a7232fb431b169b279f1b7eea14d16a1655467c61
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_4.7 GRAVADO E VERIFICADO"
    log ""
