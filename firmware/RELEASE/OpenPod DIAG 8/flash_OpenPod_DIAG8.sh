#!/bin/sh
# flash_OpenPod_DIAG8.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# DIAG 8: a casca da bateria revela se ha pre-inversao de cor
#
...
#
# USO   sudo sh flash_OpenPod_DIAG8.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_DIAG8   (2 setores, 8 KiB)"
log " 0x123000 +0x1000   <- OpenPod_DIAG8_123000.bin"
log " 0x1A6000 +0x1000   <- OpenPod_DIAG8_1A6000.bin"
...
ck_file "OpenPod_DIAG8_123000.bin" ea26be22d36913fca1acb74850c4763f06f676464c803521bb53621390691eb0
ck_file "OpenPod_DIAG8_1A6000.bin" b7fdda1a27a06a883d4af227831fcf5ef1200b6b00fbc69a5b0dfabdbe0b1f8d
ck_file "base_123000.bin" 5ebf661547a6485b83937f5c6abc9f618300033847a03542be50621e7c29358f
ck_file "base_1A6000.bin" 798874692c728fc51d415bcd86abf3edaae64ef91df1d5b829165745784d90a8
...
ck "FIRM" 57344 1647984 490e6a7d400336d7cfc190a3e0c58063bd51f4e1df9e8a4ef7c0a3fb64c7b393
...
log "   muda   : DIAG 8: a casca da bateria revela se ha pre-inversao de cor"
...
wr "4/6 1/2" 0x123000 "OpenPod_DIAG8_123000.bin" ea26be22d36913fca1acb74850c4763f06f676464c803521bb53621390691eb0
wr "4/6 2/2" 0x1A6000 "OpenPod_DIAG8_1A6000.bin" b7fdda1a27a06a883d4af227831fcf5ef1200b6b00fbc69a5b0dfabdbe0b1f8d
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 221fa8ea72220357f7ed5e3a192602caf33fff8aeacf42f900b1309c74613de3
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_DIAG8 GRAVADO E VERIFICADO"
    log ""
