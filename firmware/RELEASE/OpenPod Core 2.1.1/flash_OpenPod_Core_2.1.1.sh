#!/bin/sh
# flash_OpenPod_Core_2.1.1.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# O fundo do conteiner e da linha passa a vir de cor_tela.
#
...
#
# USO   sudo sh flash_OpenPod_Core_2.1.1.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD CORE 2.1.1   (2 setores, 8 KiB)"
log " 0x121000 +0x1000   <- OpenPod_Core_2.1.1_121000.bin"
log " 0x1A4000 +0x1000   <- OpenPod_Core_2.1.1_1A4000.bin"
...
ck_file "OpenPod_Core_2.1.1_121000.bin" 0008e41e788a3a286501b33e99d93e8be8d9992a108f6c523b8add64e58a02a3
ck_file "OpenPod_Core_2.1.1_1A4000.bin" 119a172090f024fc121e9582dd5516beabe6346b6720343cb6ad20b366f46298
ck_file "base_121000.bin" 207074b906bf0fe4830e2d66ed56b972c21690c31dda86ec132b752ae9025a9e
ck_file "base_1A4000.bin" ca3d72e89620723cd4d4b475e5855de49c0591d062c647f96bec626a3b2fbe2b
...
ck "FIRM" 57344 1647984 3e4169cc0e3e1e85c51fe53eb860873dad7d6d8a1cc401cb946d1cc34bca4fae
...
log "   muda   : O fundo do conteiner e da linha passa a vir de cor_tela."
...
wr "4/6 1/2" 0x121000 "OpenPod_Core_2.1.1_121000.bin" 0008e41e788a3a286501b33e99d93e8be8d9992a108f6c523b8add64e58a02a3
wr "4/6 2/2" 0x1A4000 "OpenPod_Core_2.1.1_1A4000.bin" 119a172090f024fc121e9582dd5516beabe6346b6720343cb6ad20b366f46298
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 4d30061107d818da82983612e700f2fdc2407f5f979241e6eb096bfd196e35f5
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD CORE 2.1.1 GRAVADO E VERIFICADO"
    log ""
