#!/bin/sh
# flash_OpenPod 2.4.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# O titulo deixa de se acumular. Sonda com buffer valido.
#
...
#
# USO   sudo sh flash_OpenPod 2.4.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_OpenPod 2.4
LOG="$WORK/flash_OpenPod 2.4.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD 2.4   (3 setores, 12 KiB)"
log " 0x1A5000 +0x1000   <- OpenPod 2.4_1A5000.bin"
log " 0x10A000 +0x1000   <- OpenPod 2.4_10A000.bin"
log " 0x123000 +0x1000   <- OpenPod 2.4_123000.bin"
...
ck_file OpenPod 2.4_1A5000.bin 29b0b2ab1cfc1aca3745712a1c176279154875116c0c24fc8e2194ab0f733321
ck_file OpenPod 2.4_10A000.bin 0427682bc43da4e41534a5ba410315852e100d41d34531488802d69b218943db
ck_file OpenPod 2.4_123000.bin 0dd1b355e8afc41093cf8e45a1a7cbb9a0d1385c706eb93717eb3053dd5df88d
...
log "   muda   : O titulo deixa de se acumular. Sonda com buffer valido."
...
wr "4/6 1/3" 0x1A5000 OpenPod 2.4_1A5000.bin 29b0b2ab1cfc1aca3745712a1c176279154875116c0c24fc8e2194ab0f733321
wr "4/6 2/3" 0x10A000 OpenPod 2.4_10A000.bin 0427682bc43da4e41534a5ba410315852e100d41d34531488802d69b218943db
wr "4/6 3/3" 0x123000 OpenPod 2.4_123000.bin 0dd1b355e8afc41093cf8e45a1a7cbb9a0d1385c706eb93717eb3053dd5df88d
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 7d3248092bce7f51be169c08a11b36b50ea7915b8dc8330417b3758c32c1fa62
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD 2.4 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_OpenPod 2.4.log"
log ""
