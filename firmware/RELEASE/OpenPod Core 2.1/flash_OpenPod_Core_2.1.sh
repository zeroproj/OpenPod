...
#
# USO   sudo sh flash_OpenPod_Core_2.1.sh [/opt/smartlink_flash]
...
ck "FIRM" 57344 1647984 de569488054688e457a64d59fa59c36caaf745d46e59ebca6ba98ae829796eef
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD CORE 2.1 GRAVADO E VERIFICADO"
    log ""
