#!/bin/sh
# flash_OpenPod_Core_3.6.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# 3.4 + a inicializacao do tuner FM
#
...
#
# USO   sudo sh flash_OpenPod_Core_3.6.sh [/opt/smartlink_flash]
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_CORE_3.6   (1 setores, 4 KiB)"
log " 0x1A6000 +0x1000   <- OpenPod_Core_3.6_1A6000.bin"
...
ck_file "OpenPod_Core_3.6_1A6000.bin" 6369b531982967946f84825bd9370da6d7a297fab6c15a37ab61be52b9a914ec
ck_file "base_1A6000.bin" 617989f51e653b8963cd633504695750e5cdb783a036e0e923ac15cfb48217e8
...
log "   muda   : 3.4 + a inicializacao do tuner FM"
...
wr "4/6 1/1" 0x1A6000 "OpenPod_Core_3.6_1A6000.bin" 6369b531982967946f84825bd9370da6d7a297fab6c15a37ab61be52b9a914ec
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_CORE_3.6 GRAVADO E VERIFICADO"
    log ""
