#!/bin/sh
# flash_v027.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# selecao da home vira barra de fundo em vez de cor de texto
#
...
#
# USO   sudo sh flash_v027.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v027
LOG="$WORK/flash_v027.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V027   (3 setores, 12 KiB)"
log " 0x00D000 +0x1000   <- v027_D000.bin"
log " 0x12E000 +0x1000   <- v027_12E000.bin"
log " 0x1A3000 +0x1000   <- v027_1A3000.bin"
...
ck_file v027_D000.bin 9d11ad554a6559450aa2e1739d4a156fc54fa35bdd1b92bd8e03bea6337a0340
ck_file v027_12E000.bin 33a243cc59111f457d28c03ab3d39df183b9c9861455af540592333b49bfc15a
ck_file v027_1A3000.bin b5d4e8e455035e4879edb5290ce40b6bc7ba11023d888c8b7df29186038aff51
ck_file base_D000.bin cf8aaed69ad703d02720535292c9ccd2b0d913a51461ba57a96bd4b049b7a0dc
ck_file base_12E000.bin bacf1be5da36996422d6f905cdfdf031a6289a823ce21cc25e5e6b5b75ea63d6
ck_file base_1A3000.bin 7ac7ae5cfcdb14a1d06575a6deaa7a9deafebd4bec3ce66578936f9d7d8fc482
...
ck "ptable" 53248 64 156b535104fd7e2929bef1589bb3237f5a0737a188045ca1ad880f2c3693dde4
ck "FIRM" 57344 1647984 68e3966fa9137fd6149bfd215fab89344fb08609e1ce0ed83dfc47df38a0367b
...
log "   muda   : selecao da home vira barra de fundo em vez de cor de texto"
...
wr "4/6 1/3" 0xD000 v027_D000.bin 9d11ad554a6559450aa2e1739d4a156fc54fa35bdd1b92bd8e03bea6337a0340
wr "4/6 2/3" 0x12E000 v027_12E000.bin 33a243cc59111f457d28c03ab3d39df183b9c9861455af540592333b49bfc15a
wr "4/6 3/3" 0x1A3000 v027_1A3000.bin b5d4e8e455035e4879edb5290ce40b6bc7ba11023d888c8b7df29186038aff51
rm -f "$WORK/sec.bin"
...
ck2 "ptable" 53248 64 5d7b04ee1122e407da7bac9df4f30bf8d0e41f79759236fe1e2203b1d79cd30f
ck2 "FIRM" 57344 1647984 459e338818e680c17be7bedd9fff51005ec457a271aa886ab4e556ff70f342e3
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V027 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v027.log"
log ""
