#!/bin/sh
# flash_v033.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Chevron menor 4x7 traco 1px
#
...
#
# USO   sudo sh flash_v033.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v033
LOG="$WORK/flash_v033.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V033   (3 setores, 12 KiB)"
log " 0x0CE000 +0x1000   <- v033_CE000.bin"
log " 0x0CF000 +0x1000   <- v033_CF000.bin"
log " 0x0D0000 +0x1000   <- v033_D0000.bin"
...
ck_file v033_CE000.bin 89b2779769649cec6878f09032af14b1148073fe7e4f4de5b2055a685b820a45
ck_file v033_CF000.bin 444a33b06a3f04df497f9697a00856292e761d758029f9c33e981586b8fccef8
ck_file v033_D0000.bin 9c0b0b4382c9bd79daa6b0085bcdfeef1a97736c65853e70a00f24012f9b883f
...
log "   muda   : Chevron menor 4x7 traco 1px"
...
wr "4/6 1/3" 0xCE000 v033_CE000.bin 89b2779769649cec6878f09032af14b1148073fe7e4f4de5b2055a685b820a45
wr "4/6 2/3" 0xCF000 v033_CF000.bin 444a33b06a3f04df497f9697a00856292e761d758029f9c33e981586b8fccef8
wr "4/6 3/3" 0xD0000 v033_D0000.bin 9c0b0b4382c9bd79daa6b0085bcdfeef1a97736c65853e70a00f24012f9b883f
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 0eb044137385b6abf0a205900d661360f856dc8d9e9d000162492691ee2e36e4
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V033 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v033.log"
log ""
