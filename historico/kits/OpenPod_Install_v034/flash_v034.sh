...
log "======================================================================"
log " OpenPod — gravacao do V034   (2 setores, 8 KiB)"
...
ck "FIRM" 57344 1647984 0eb044137385b6abf0a205900d661360f856dc8d9e9d000162492691ee2e36e4
...
log "   muda   : Sem barra de rolagem na home"
...
wr "4/6 1/2" 0x1A3000 v034_1A3000.bin b4680d390d9d96827e1d253e8c7ff6709babafb6302f2685288c66491ff78d25
wr "4/6 2/2" 0x12E000 v034_12E000.bin 421015b59984adaa39edba27ef90dc52310983300f4e740414a930765926700f
rm -f "$WORK/sec.bin"
