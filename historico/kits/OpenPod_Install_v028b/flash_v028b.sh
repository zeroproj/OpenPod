#!/bin/sh
# flash_v028b.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Corrige o fundo branco das linhas nao selecionadas. SEM tocar 0x00D000.
#
...
#
# USO   sudo sh flash_v028b.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v028b
LOG="$WORK/flash_v028b.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V028B   (2 setores, 8 KiB)"
log " 0x1A3000 +0x1000   <- v028b_1A3000.bin"
log " 0x12E000 +0x1000   <- v028b_12E000.bin"
...
ck_file v028b_1A3000.bin 8dc16ff6c6b288e24dccab15751fdf56cd88984f2007a411cc2f632f85c9ec76
ck_file v028b_12E000.bin 4178e4d94f75fac176dd9ff886c0c27799ba7087463b28b0783d793b6a4380a3
...
log "   muda   : Corrige o fundo branco das linhas nao selecionadas. SEM tocar 0x00D000."
...
wr "4/6 1/2" 0x1A3000 v028b_1A3000.bin 8dc16ff6c6b288e24dccab15751fdf56cd88984f2007a411cc2f632f85c9ec76
wr "4/6 2/2" 0x12E000 v028b_12E000.bin 4178e4d94f75fac176dd9ff886c0c27799ba7087463b28b0783d793b6a4380a3
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V028B GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v028b.log"
log ""
