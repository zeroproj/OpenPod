#!/bin/sh
# flash_v019.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# sobe o icone de bateria 2 px, alinhando com o texto da faixa
#
...
#
# USO   sudo sh flash_v019.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v019
LOG="$WORK/flash_v019.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V019   (2 setores, 8 KiB)"
log " 0x00D000 +0x1000   <- v019_D000.bin"
log " 0x122000 +0x1000   <- v019_122000.bin"
...
ck_file v019_D000.bin 121ca491c168bd0395911504925208f22abd01a5885ab1c60511b91cd8206c29
ck_file v019_122000.bin be30671e2574ce78d521fb7f979c010446deee2554d50c197bb7c5fe2ab76298
ck_file base_D000.bin f795becc340e8f79b0d1dc80ca0314a5fc463912ea3c4c32c16ab4036c717b74
ck_file base_122000.bin a12a4865bcef55276a5df3418e5f71b2c63381cc5d8a22078cdf34ad15823831
...
ck "ptable" 53248 64 9af77158b0f69796d51cafebcda1243c7cc69dc83992bd420cabcc8d90884dff
ck "FIRM" 57344 1647984 954789a8104d35c7355855e7050e44b8dc25fd039f6b9d07b8cba65d162df0c8
...
log "   muda   : sobe o icone de bateria 2 px, alinhando com o texto da faixa"
...
wr "4/6 1/2" 0xD000 v019_D000.bin 121ca491c168bd0395911504925208f22abd01a5885ab1c60511b91cd8206c29
wr "4/6 2/2" 0x122000 v019_122000.bin be30671e2574ce78d521fb7f979c010446deee2554d50c197bb7c5fe2ab76298
rm -f "$WORK/sec.bin"
...
ck2 "ptable" 53248 64 560d0f801ff781d7272830972a5eebcdf7ccceb521ddf81c058fbc53312bebfe
ck2 "FIRM" 57344 1647984 dbb4eb4239ccc519ec60807e3f3005e9de5e43bf67e306384b2a5174dd5fd216
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V019 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v019.log"
log ""
