#!/bin/sh
# flash_v009.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# EXPERIMENTO: inverte o tema — fundo claro e texto escuro, como o nano 2G
#
...
#
# USO   sudo sh flash_v009.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v009
LOG="$WORK/flash_v009.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V009   (2 setores, 8 KiB)"
log " 0x00D000 +0x1000   <- v009_D000.bin"
log " 0x121000 +0x1000   <- v009_121000.bin"
...
ck_file v009_D000.bin 55c583039e5697b5d0c30e942f0b04b7d8bcb61a7c8094092fe266a0021695e0
ck_file v009_121000.bin 09c893069456f4a5eaa3ff5e9b7b263d00e030e0d38dbf3c3d178c65bc319626
...
log "   muda   : EXPERIMENTO: inverte o tema — fundo claro e texto escuro, como o nano 2G"
...
wr "4/6 1/2" 0xD000 v009_D000.bin 55c583039e5697b5d0c30e942f0b04b7d8bcb61a7c8094092fe266a0021695e0
wr "4/6 2/2" 0x121000 v009_121000.bin 09c893069456f4a5eaa3ff5e9b7b263d00e030e0d38dbf3c3d178c65bc319626
rm -f "$WORK/sec.bin"
...
ck2 "ptable" 53248 64 0bafbfcdd179be00b999090dd572a519a1c0aaf5a36e2ae99fc0c9a35ace408f
ck2 "FIRM" 57344 1647984 b76b59f5287aad3ca2501fb3205ea3b70b222c0494447db7d8dbac5efa8b3fab
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V009 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v009.log"
log ""
