#!/bin/sh
# flash_v026.sh — OpenPod. GERADO por tools/make_install_kit.py.
...
#
# USO   sudo sh flash_v026.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v026
LOG="$WORK/flash_v026.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V026   (4 setores, 16 KiB)"
log " 0x00D000 +0x1000   <- v026_D000.bin"
log " 0x12E000 +0x1000   <- v026_12E000.bin"
log " 0x12F000 +0x1000   <- v026_12F000.bin"
log " 0x1A3000 +0x1000   <- v026_1A3000.bin"
...
ck_file v026_D000.bin cf8aaed69ad703d02720535292c9ccd2b0d913a51461ba57a96bd4b049b7a0dc
ck_file v026_12E000.bin bacf1be5da36996422d6f905cdfdf031a6289a823ce21cc25e5e6b5b75ea63d6
ck_file v026_12F000.bin 5252d4ac12cb5f879d331fa081a6ff2c1663cdb8849bf69fd1d65009ccb08c38
ck_file v026_1A3000.bin 7ac7ae5cfcdb14a1d06575a6deaa7a9deafebd4bec3ce66578936f9d7d8fc482
ck_file base_D000.bin aa5e1a7b10879b0c60598dce864387774b28305dad2d2f09473bcba48a29f08c
ck_file base_12E000.bin b37ca356cd5c2fdb5b360386b224cd73061ae2184a94ad2e3413d1eda36bb3fa
...
ck "ptable" 53248 64 2accab05221e48774f0fafb0f404a8ecb058d6fe1623127027ecfa3799b1fd01
ck "FIRM" 57344 1647984 69a0baaaa26c7ad5539f41bda536bf5710dd07e1b4470b0e7864264bdbcdeeef
...
log "   muda   : SOZINHO: pagina 0x53 passa de 3 para 6 itens. Sem roteamento nenhum."
...
wr "4/6 1/4" 0xD000 v026_D000.bin cf8aaed69ad703d02720535292c9ccd2b0d913a51461ba57a96bd4b049b7a0dc
wr "4/6 2/4" 0x12E000 v026_12E000.bin bacf1be5da36996422d6f905cdfdf031a6289a823ce21cc25e5e6b5b75ea63d6
wr "4/6 3/4" 0x12F000 v026_12F000.bin 5252d4ac12cb5f879d331fa081a6ff2c1663cdb8849bf69fd1d65009ccb08c38
wr "4/6 4/4" 0x1A3000 v026_1A3000.bin 7ac7ae5cfcdb14a1d06575a6deaa7a9deafebd4bec3ce66578936f9d7d8fc482
rm -f "$WORK/sec.bin"
...
ck2 "ptable" 53248 64 156b535104fd7e2929bef1589bb3237f5a0737a188045ca1ad880f2c3693dde4
ck2 "FIRM" 57344 1647984 68e3966fa9137fd6149bfd215fab89344fb08609e1ce0ed83dfc47df38a0367b
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V026 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v026.log"
log ""
