#!/bin/sh
# flash_v031.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# A selecao restaurada na criacao da home tambem vira barra azul
#
...
#
# USO   sudo sh flash_v031.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v031
LOG="$WORK/flash_v031.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V031   (1 setores, 4 KiB)"
log " 0x12E000 +0x1000   <- v031_12E000.bin"
...
ck_file v031_12E000.bin a1bf2e89607dd9d5205d0a472c70dadfd52f99aee67367d5c4b4e948978ab846
ck_file base_12E000.bin 4178e4d94f75fac176dd9ff886c0c27799ba7087463b28b0783d793b6a4380a3
...
log "   muda   : A selecao restaurada na criacao da home tambem vira barra azul"
...
wr "4/6 1/1" 0x12E000 v031_12E000.bin a1bf2e89607dd9d5205d0a472c70dadfd52f99aee67367d5c4b4e948978ab846
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 f129aa55530bfc4a5dd51bba07ade15d69f3c717e62e360feac4cdc533a00616
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V031 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v031.log"
log ""
