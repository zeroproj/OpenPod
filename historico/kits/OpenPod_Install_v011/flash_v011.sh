#!/bin/sh
# flash_v011.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# logo do OpenPod com fundo claro, casando com o tema nano
#
...
#
# USO   sudo sh flash_v011.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v011
LOG="$WORK/flash_v011.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V011   (3 setores, 12 KiB)"
log " 0x00D000 +0x1000   <- v011_D000.bin"
log " 0x0CC000 +0x1000   <- v011_CC000.bin"
log " 0x0CD000 +0x1000   <- v011_CD000.bin"
...
ck_file v011_D000.bin 21e5245bfc3e0437724069bc402c5dd9df5e4a6fd0e997abd302d9f8e75ac97f
ck_file v011_CC000.bin a7f4106e60f85571d977a8f404dce64cc61c1d7bc1d40efc1016fc32962a499d
ck_file v011_CD000.bin b42528f3b5642d43c8193218ed553445e4bc00e51c0975f237636b509e7f465b
...
log "   muda   : logo do OpenPod com fundo claro, casando com o tema nano"
...
wr "4/6 1/3" 0xD000 v011_D000.bin 21e5245bfc3e0437724069bc402c5dd9df5e4a6fd0e997abd302d9f8e75ac97f
wr "4/6 2/3" 0xCC000 v011_CC000.bin a7f4106e60f85571d977a8f404dce64cc61c1d7bc1d40efc1016fc32962a499d
wr "4/6 3/3" 0xCD000 v011_CD000.bin b42528f3b5642d43c8193218ed553445e4bc00e51c0975f237636b509e7f465b
rm -f "$WORK/sec.bin"
...
ck2 "ptable" 53248 64 f82396de3737c15e51c74e4d4c669611e7eb0654d7c6b0c3d195b1d9dc33199b
ck2 "FIRM" 57344 1647984 27ed59eca70a276f0a77cf677029d89569590219db0dd81a228ca249afaecfd0
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V011 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v011.log"
log ""
