#!/bin/sh
# flash_v044.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Home no padrao borda a borda + versao OpenPod na tela Informacao
#
...
#
# USO   sudo sh flash_v044.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v044
LOG="$WORK/flash_v044.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V044   (7 setores, 28 KiB)"
log " 0x1A3000 +0x1000   <- v044_1A3000.bin"
log " 0x048000 +0x1000   <- v044_48000.bin"
log " 0x0CE000 +0x1000   <- v044_CE000.bin"
log " 0x0CF000 +0x1000   <- v044_CF000.bin"
log " 0x0D0000 +0x1000   <- v044_D0000.bin"
log " 0x10A000 +0x1000   <- v044_10A000.bin"
log " 0x12E000 +0x1000   <- v044_12E000.bin"
...
ck_file v044_1A3000.bin e874a4c7f0f2d53f6bdd4a440cf32968cac301f46c3532b03c80e92400d1bc30
ck_file v044_48000.bin de2dcc3d2e9dce53f640f23edc030dc04910a562e6e60a981af1342988df9233
ck_file v044_CE000.bin 719e073c97507d92824536e965b0b0377b1a8b951af3b90efbec4b567ccc8234
ck_file v044_CF000.bin 3431383721510cf1c211de027cf958c183e16db5fabb6b230eb284c85e196aa9
ck_file v044_D0000.bin 3431383721510cf1c211de027cf958c183e16db5fabb6b230eb284c85e196aa9
ck_file v044_10A000.bin b3a62ac8945aa089e9fcd8c63cc76a38804e21cc78e48e3c123ed0ecb82513f2
ck_file v044_12E000.bin 2e9ebe303f47f437476087d65046002259696940dea07591c9e5af21f042e863
...
log "   muda   : Home no padrao borda a borda + versao OpenPod na tela Informacao"
...
wr "4/6 1/7" 0x1A3000 v044_1A3000.bin e874a4c7f0f2d53f6bdd4a440cf32968cac301f46c3532b03c80e92400d1bc30
wr "4/6 2/7" 0x48000 v044_48000.bin de2dcc3d2e9dce53f640f23edc030dc04910a562e6e60a981af1342988df9233
wr "4/6 3/7" 0xCE000 v044_CE000.bin 719e073c97507d92824536e965b0b0377b1a8b951af3b90efbec4b567ccc8234
wr "4/6 4/7" 0xCF000 v044_CF000.bin 3431383721510cf1c211de027cf958c183e16db5fabb6b230eb284c85e196aa9
wr "4/6 5/7" 0xD0000 v044_D0000.bin 3431383721510cf1c211de027cf958c183e16db5fabb6b230eb284c85e196aa9
wr "4/6 6/7" 0x10A000 v044_10A000.bin b3a62ac8945aa089e9fcd8c63cc76a38804e21cc78e48e3c123ed0ecb82513f2
wr "4/6 7/7" 0x12E000 v044_12E000.bin 2e9ebe303f47f437476087d65046002259696940dea07591c9e5af21f042e863
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 ae841a2846cefa72e9b44bc76352cc30c3c9db95ec2be0134b1fb1e92bd2e055
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V044 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v044.log"
log ""
