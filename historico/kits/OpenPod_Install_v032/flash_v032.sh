#!/bin/sh
# flash_v032.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Barra de 110 px: o chevron volta a aparecer
#
...
#
# USO   sudo sh flash_v032.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v032
LOG="$WORK/flash_v032.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V032   (1 setores, 4 KiB)"
log " 0x12E000 +0x1000   <- v032_12E000.bin"
...
ck_file v032_12E000.bin fa77b67bafc9f800791e273ccb4951232a38e5bc7576bccb1e1bceda0ede1842
ck_file base_12E000.bin a1bf2e89607dd9d5205d0a472c70dadfd52f99aee67367d5c4b4e948978ab846
...
ck "FIRM" 57344 1647984 f129aa55530bfc4a5dd51bba07ade15d69f3c717e62e360feac4cdc533a00616
...
log "   muda   : Barra de 110 px: o chevron volta a aparecer"
...
wr "4/6 1/1" 0x12E000 v032_12E000.bin fa77b67bafc9f800791e273ccb4951232a38e5bc7576bccb1e1bceda0ede1842
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 c5b9862521466fa40d70972fdda59dc7936652a500a4f35e9b97238927943f7c
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V032 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v032.log"
log ""
