#!/bin/sh
# flash_v005.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# corrige a cor dos rotulos: o display usa RGB565 com bytes trocados
#
...
#
# USO   sudo sh flash_v005.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v005
LOG="$WORK/flash_v005.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V005   (2 setores, 8 KiB)"
log " 0x00D000 +0x1000   <- v005_D000.bin"
log " 0x12E000 +0x1000   <- v005_12E000.bin"
...
ck_file v005_D000.bin b2f3e780ecb0f286edc1f6534c698797a83223afc3df68de092ab63ee5dd7e2a
ck_file v005_12E000.bin 460cd8b5a036ccfc103adc88724e8ef4d3628efec3e1cb1eda828e9f81113014
...
ck "ptable" 53248 64 7b1c08c229620982f64e278aefcfff4e6b330f5b9de058c25607eabbf8f9ad03
ck "FIRM" 57344 1647984 244ad8e55386f0b400b56dfa10fcd92015582ef1dbc8e91d93392d4a5f8278d2
...
log "   muda   : corrige a cor dos rotulos: o display usa RGB565 com bytes trocados"
...
wr "4/6 1/2" 0xD000 v005_D000.bin b2f3e780ecb0f286edc1f6534c698797a83223afc3df68de092ab63ee5dd7e2a
wr "4/6 2/2" 0x12E000 v005_12E000.bin 460cd8b5a036ccfc103adc88724e8ef4d3628efec3e1cb1eda828e9f81113014
rm -f "$WORK/sec.bin"
...
ck2 "ptable" 53248 64 5f1e69c4190fb60471b6a7597920fdc8e74a68a4c2b2fcec457cab26aca62bb4
ck2 "FIRM" 57344 1647984 ffc5e6736fe58f86063dfad23b6c36f67e51820693010a1c1af53b9eb0848318
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V005 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v005.log"
log ""
