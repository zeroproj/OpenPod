#!/bin/sh
# flash_v036.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Barra de rolagem invisivel via LV_PART_SCROLLBAR
#
...
#
# USO   sudo sh flash_v036.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v036
LOG="$WORK/flash_v036.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V036   (1 setores, 4 KiB)"
log " 0x1A3000 +0x1000   <- v036_1A3000.bin"
...
ck_file v036_1A3000.bin b6b818a389fe7cf678e4ffaef83d6f261135f5ce0437415d2232bd4e486ed08d
ck_file base_1A3000.bin b4680d390d9d96827e1d253e8c7ff6709babafb6302f2685288c66491ff78d25
...
log "   muda   : Barra de rolagem invisivel via LV_PART_SCROLLBAR"
...
wr "4/6 1/1" 0x1A3000 v036_1A3000.bin b6b818a389fe7cf678e4ffaef83d6f261135f5ce0437415d2232bd4e486ed08d
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V036 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v036.log"
log ""
