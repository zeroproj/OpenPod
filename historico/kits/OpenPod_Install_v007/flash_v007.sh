#!/bin/sh
# flash_v007.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# substitui o logo GENAI pelo logo do OpenPod na tela de abertura
#
...
#
# USO   sudo sh flash_v007.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v007
LOG="$WORK/flash_v007.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V007   (3 setores, 12 KiB)"
log " 0x00D000 +0x1000   <- v007_D000.bin"
log " 0x0CC000 +0x1000   <- v007_CC000.bin"
log " 0x0CD000 +0x1000   <- v007_CD000.bin"
...
ck_file v007_D000.bin 4b24f08419fa0ed4935f77b193ef311b280328924545180475573be7e000c570
ck_file v007_CC000.bin ef8ffb2966867c44f8a87315ad7469a97018d0b7367ce864c19ffa102a8ba165
ck_file v007_CD000.bin d77710d5a99db95967dc5ba61a2f3bbc2f1081cea272c688f616c9a305aabc6c
...
ck "ptable" 53248 64 b1329cf4330fd862ad2fd743dbfe59305841fbcdba97b3e454f699e089e5ad60
ck "FIRM" 57344 1647984 4d6c709d2b7c3e00e04612c6c430f5f989e340eaab0f7ba5542807f287ec5dab
...
log "   muda   : substitui o logo GENAI pelo logo do OpenPod na tela de abertura"
...
wr "4/6 1/3" 0xD000 v007_D000.bin 4b24f08419fa0ed4935f77b193ef311b280328924545180475573be7e000c570
wr "4/6 2/3" 0xCC000 v007_CC000.bin ef8ffb2966867c44f8a87315ad7469a97018d0b7367ce864c19ffa102a8ba165
wr "4/6 3/3" 0xCD000 v007_CD000.bin d77710d5a99db95967dc5ba61a2f3bbc2f1081cea272c688f616c9a305aabc6c
rm -f "$WORK/sec.bin"
...
ck2 "ptable" 53248 64 55990cc24fb4c7a073ce2d5f3cd66cccf4a9486528f0ccb8d21977e97aca3a4a
ck2 "FIRM" 57344 1647984 6fd51dab368d63bc10262a46a6b50d4c72bf6bf847d7d675c656aa7b510f80a2
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V007 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v007.log"
log ""
