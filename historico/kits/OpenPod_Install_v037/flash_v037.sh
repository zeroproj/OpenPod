#!/bin/sh
# flash_v037.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Barra de rolagem: estiliza o conteiner certo (r7)
#
...
#
# USO   sudo sh flash_v037.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v037
LOG="$WORK/flash_v037.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V037   (2 setores, 8 KiB)"
log " 0x1A3000 +0x1000   <- v037_1A3000.bin"
log " 0x12E000 +0x1000   <- v037_12E000.bin"
...
ck_file v037_1A3000.bin cb28783690b8a9b7421160db7f67f6f36e9084b8afe4085cb54abc41f0c3c80d
ck_file v037_12E000.bin ad7c05b035cd4b48cefccd8cddf01d59b3de49bb0228c0dd847ba751cc6d92ae
...
log "   muda   : Barra de rolagem: estiliza o conteiner certo (r7)"
...
wr "4/6 1/2" 0x1A3000 v037_1A3000.bin cb28783690b8a9b7421160db7f67f6f36e9084b8afe4085cb54abc41f0c3c80d
wr "4/6 2/2" 0x12E000 v037_12E000.bin ad7c05b035cd4b48cefccd8cddf01d59b3de49bb0228c0dd847ba751cc6d92ae
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 e24c8f335e654324e3c406e12c6be3f874070f0427ad03ad4a15667f5182c8b3
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V037 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v037.log"
log ""
