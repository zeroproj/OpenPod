#!/bin/sh
# flash_v004.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# rotulos do menu em cinza e selecao em ciano
#
...
#
# USO   sudo sh flash_v004.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v004
LOG="$WORK/flash_v004.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V004   (2 setores, 8 KiB)"
log " 0x00D000 +0x1000   <- v004_D000.bin"
log " 0x12E000 +0x1000   <- v004_12E000.bin"
...
ck_file v004_D000.bin a9a0b625fa0f7fda6b0608688f290493b7039b45f75c665cd2559b5159db4129
ck_file v004_12E000.bin 4747ed3a3e7ad8597fb2018747601f9b176a730765ae67c081cc443460f9d9fa
...
ck "ptable" 53248 64 93450a066ef27e0c3f22d91accea08eade810f116b9417e1b8ff151eba4be4d9
ck "FIRM" 57344 1647984 d4b16947a7cab225e19e6db8c93197ab006f2fd0e2a69f719733d335400c0092
...
log "   muda   : rotulos do menu em cinza e selecao em ciano"
...
wr "4/6 1/2" 0xD000 v004_D000.bin a9a0b625fa0f7fda6b0608688f290493b7039b45f75c665cd2559b5159db4129
wr "4/6 2/2" 0x12E000 v004_12E000.bin 4747ed3a3e7ad8597fb2018747601f9b176a730765ae67c081cc443460f9d9fa
rm -f "$WORK/sec.bin"
...
ck2 "ptable" 53248 64 7b1c08c229620982f64e278aefcfff4e6b330f5b9de058c25607eabbf8f9ad03
ck2 "FIRM" 57344 1647984 244ad8e55386f0b400b56dfa10fcd92015582ef1dbc8e91d93392d4a5f8278d2
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V004 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v004.log"
log ""
