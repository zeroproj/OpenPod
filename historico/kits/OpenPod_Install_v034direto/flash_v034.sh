#!/bin/sh
# flash_v034.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# V032 -> V034 direto: chevron menor + sem barra de rolagem
#
...
#
# USO   sudo sh flash_v034.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v034
LOG="$WORK/flash_v034.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V034   (5 setores, 20 KiB)"
log " 0x0CE000 +0x1000   <- v034_CE000.bin"
log " 0x0CF000 +0x1000   <- v034_CF000.bin"
log " 0x0D0000 +0x1000   <- v034_D0000.bin"
log " 0x1A3000 +0x1000   <- v034_1A3000.bin"
log " 0x12E000 +0x1000   <- v034_12E000.bin"
...
ck_file v034_CE000.bin 89b2779769649cec6878f09032af14b1148073fe7e4f4de5b2055a685b820a45
ck_file v034_CF000.bin 444a33b06a3f04df497f9697a00856292e761d758029f9c33e981586b8fccef8
ck_file v034_D0000.bin 9c0b0b4382c9bd79daa6b0085bcdfeef1a97736c65853e70a00f24012f9b883f
ck_file v034_1A3000.bin b4680d390d9d96827e1d253e8c7ff6709babafb6302f2685288c66491ff78d25
ck_file v034_12E000.bin 421015b59984adaa39edba27ef90dc52310983300f4e740414a930765926700f
...
log "   muda   : V032 -> V034 direto: chevron menor + sem barra de rolagem"
...
wr "4/6 1/5" 0xCE000 v034_CE000.bin 89b2779769649cec6878f09032af14b1148073fe7e4f4de5b2055a685b820a45
wr "4/6 2/5" 0xCF000 v034_CF000.bin 444a33b06a3f04df497f9697a00856292e761d758029f9c33e981586b8fccef8
wr "4/6 3/5" 0xD0000 v034_D0000.bin 9c0b0b4382c9bd79daa6b0085bcdfeef1a97736c65853e70a00f24012f9b883f
wr "4/6 4/5" 0x1A3000 v034_1A3000.bin b4680d390d9d96827e1d253e8c7ff6709babafb6302f2685288c66491ff78d25
wr "4/6 5/5" 0x12E000 v034_12E000.bin 421015b59984adaa39edba27ef90dc52310983300f4e740414a930765926700f
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 778c0152c5a2c7b1399344fec57d20973974fd24a676d766b07cb846c694f00d
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V034 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v034.log"
log ""
