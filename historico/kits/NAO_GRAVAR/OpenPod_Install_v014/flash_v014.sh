...
#
# EXPERIMENTO: menu principal passa a usar page_home_menu_create (lista) em vez da grade
#
...
die() {
    ...
    if [ "$WROTE" -ne 0 ]; then
        ...
        log "***   sudo $TOOL --id $DEV write_flash 0x123000 0 0x1000 orig_123000.bin"
...
log "======================================================================"
log " OpenPod — gravacao do V014   (2 setores, 8 KiB)"
log " 0x00D000 +0x1000   <- v014_D000.bin"
log " 0x123000 +0x1000   <- v014_123000.bin"
...
ck_file v014_D000.bin 72158c150f72891e4fa3fad577bdd5f1f0afb7e99c0fa86df37860e5cbee7a22
ck_file v014_123000.bin f863f33d9c2b2d8941f020a94913b8fb47e2e31ef4e94bf540655fbd4a2aac66
ck_file orig_D000.bin c3d16a15b7df6a8feac96169d93da82a5562ae3d17a94bf8906c2d24fc507091
ck_file orig_123000.bin fdd9e6ef0752425d429d354bc74652402039880f251c0a390b42b60c087a5805
...
log "   muda   : EXPERIMENTO: menu principal passa a usar page_home_menu_create (lista) em vez da grade"
...
wr "4/6 1/2" 0xD000 v014_D000.bin 72158c150f72891e4fa3fad577bdd5f1f0afb7e99c0fa86df37860e5cbee7a22
wr "4/6 2/2" 0x123000 v014_123000.bin f863f33d9c2b2d8941f020a94913b8fb47e2e31ef4e94bf540655fbd4a2aac66
rm -f "$WORK/sec.bin"
...
ck2 "ptable" 53248 64 4094970d7e09008bd2f3b94e5b1e92cac43854a363bc6c39002396f6e6372bf7
ck2 "FIRM" 57344 1647984 61c9de0647c2ce3cf248fcf98d80406e565e11bae16a48a4b450f3a8c261ea82
