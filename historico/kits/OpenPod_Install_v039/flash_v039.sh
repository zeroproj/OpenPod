#!/bin/sh
# flash_v039.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Lista do sistema: linha 16px e sem engrenagem
#
...
#
# USO   sudo sh flash_v039.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v039
LOG="$WORK/flash_v039.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V039   (1 setores, 4 KiB)"
log " 0x13A000 +0x1000   <- v039_13A000.bin"
...
ck_file v039_13A000.bin 0c3c38e2e72b5e1a45a5bed762bbda0700d7814f24a75fe8eb1a81b7c2374173
...
ck "FIRM" 57344 1647984 33d603819a91403a3a724ce3c296e7db193603ac25eb8392c192ebe7f6e485ea
...
log "   muda   : Lista do sistema: linha 16px e sem engrenagem"
...
wr "4/6 1/1" 0x13A000 v039_13A000.bin 0c3c38e2e72b5e1a45a5bed762bbda0700d7814f24a75fe8eb1a81b7c2374173
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 3f4119b2d6fb67e71ea2551ae95d2cb828cc4a96fdcecbebcabfa6225891efa8
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V039 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v039.log"
log ""
