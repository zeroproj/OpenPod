#!/bin/sh
# flash_v020.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# TESTE: trampolim na area livre chamado a partir da tela Configurar; prova se codigo executa por XIP de la
#
...
#
# USO   sudo sh flash_v020.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v020
LOG="$WORK/flash_v020.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V020   (3 setores, 12 KiB)"
log " 0x00D000 +0x1000   <- v020_D000.bin"
log " 0x13A000 +0x1000   <- v020_13A000.bin"
log " 0x1A3000 +0x1000   <- v020_1A3000.bin"
...
ck_file v020_D000.bin 8fbb79324cd95988c551f07f5f59e072fb2999d2612170f7bc37add1ad754132
ck_file v020_13A000.bin 560f450b325fcd237127c15a32dedea945d7902a022e837a6d600edbd51e4783
ck_file v020_1A3000.bin 210e9fc064168d61b2b359e02afb63f41f988c26375ac9e78cc7ed86b401239d
ck_file base_D000.bin 121ca491c168bd0395911504925208f22abd01a5885ab1c60511b91cd8206c29
ck_file base_13A000.bin 867fc7c28b75e651f73086c36d49c6eebf891d47ad5f36957043baa5ca22ceda
ck_file base_1A3000.bin 4e1d2cd94f20a2a109cd1dcc86ea2671ef23679c41639e2acdf2115cf8f66619
...
ck "ptable" 53248 64 560d0f801ff781d7272830972a5eebcdf7ccceb521ddf81c058fbc53312bebfe
ck "FIRM" 57344 1647984 dbb4eb4239ccc519ec60807e3f3005e9de5e43bf67e306384b2a5174dd5fd216
...
log "   muda   : TESTE: trampolim na area livre chamado a partir da tela Configurar; prova se codigo executa por XIP de la"
...
wr "4/6 1/3" 0xD000 v020_D000.bin 8fbb79324cd95988c551f07f5f59e072fb2999d2612170f7bc37add1ad754132
wr "4/6 2/3" 0x13A000 v020_13A000.bin 560f450b325fcd237127c15a32dedea945d7902a022e837a6d600edbd51e4783
wr "4/6 3/3" 0x1A3000 v020_1A3000.bin 210e9fc064168d61b2b359e02afb63f41f988c26375ac9e78cc7ed86b401239d
rm -f "$WORK/sec.bin"
...
ck2 "ptable" 53248 64 263a8f2397036b022cee4a3a96000a03126f5a87ed40e5e0ac50b3aeae5d791e
ck2 "FIRM" 57344 1647984 23c867f5066b18356563144a42a2a51aebcec561af89dea995ed9575fd37e2b0
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V020 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v020.log"
log ""
