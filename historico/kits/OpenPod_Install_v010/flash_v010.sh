#!/bin/sh
# flash_v010.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# NANO COMPLETO: fundo claro, icones e texto escuros, selecao azul
#
...
#
# USO   sudo sh flash_v010.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v010
LOG="$WORK/flash_v010.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V010   (5 setores, 20 KiB)"
log " 0x00D000 +0x1000   <- v010_D000.bin"
log " 0x0CC000 +0x1000   <- v010_CC000.bin"
log " 0x0CD000 +0x1000   <- v010_CD000.bin"
log " 0x0CE000 +0x1000   <- v010_CE000.bin"
log " 0x12E000 +0x1000   <- v010_12E000.bin"
...
ck_file v010_D000.bin e964e8a59014b76a1b5277cbde0aaea5c387d03c28cebeac458e5ee45be5a2b0
ck_file v010_CC000.bin 34447fff5f4cb196a228a74d279156c498a58d84ee03dc164060068d9ce5daae
ck_file v010_CD000.bin 249fa04f537185968b332aebc260cb3faa5456c8f47db97c3270f740665efc3b
ck_file v010_CE000.bin b2f2be8e8a5e25e6d6b61d50dd2ac0a3fe1d8ea37e8a0a71f7389e70b8ed041e
ck_file v010_12E000.bin b6536845762f96503776a643a08f15f00a738219dbf3760bda2c2f0321efd59c
...
ck "ptable" 53248 64 0bafbfcdd179be00b999090dd572a519a1c0aaf5a36e2ae99fc0c9a35ace408f
ck "FIRM" 57344 1647984 b76b59f5287aad3ca2501fb3205ea3b70b222c0494447db7d8dbac5efa8b3fab
...
log "   muda   : NANO COMPLETO: fundo claro, icones e texto escuros, selecao azul"
...
wr "4/6 1/5" 0xD000 v010_D000.bin e964e8a59014b76a1b5277cbde0aaea5c387d03c28cebeac458e5ee45be5a2b0
wr "4/6 2/5" 0xCC000 v010_CC000.bin 34447fff5f4cb196a228a74d279156c498a58d84ee03dc164060068d9ce5daae
wr "4/6 3/5" 0xCD000 v010_CD000.bin 249fa04f537185968b332aebc260cb3faa5456c8f47db97c3270f740665efc3b
wr "4/6 4/5" 0xCE000 v010_CE000.bin b2f2be8e8a5e25e6d6b61d50dd2ac0a3fe1d8ea37e8a0a71f7389e70b8ed041e
wr "4/6 5/5" 0x12E000 v010_12E000.bin b6536845762f96503776a643a08f15f00a738219dbf3760bda2c2f0321efd59c
rm -f "$WORK/sec.bin"
...
ck2 "ptable" 53248 64 588785f987617321a2c9aa065a59a98a9a75f2fbc3c5484b101b59ff811208be
ck2 "FIRM" 57344 1647984 720971c31bf7df790868083c07f1dbb3ecb5160d42a7d64f0a74cae322b32c33
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V010 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v010.log"
log ""
