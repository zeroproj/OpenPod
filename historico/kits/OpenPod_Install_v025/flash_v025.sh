#!/bin/sh
# flash_v025.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Parte A sem mexer no limite do laco: 9 objetos criados, 5 escondidos fora da tela
#
# Grava 7 setores de 4096 B (28 KiB). O bootloader (0x0..0xD000)
# nao e endereçado. write_flash sempre com 0 no 2o argumento, a
# partir de um arquivo por setor (docs/WRITE_FLASH_SEMANTICS.md).
#
# USO   sudo sh flash_v025.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_v025
LOG="$WORK/flash_v025.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do V025   (7 setores, 28 KiB)"
log " 0x00D000 +0x1000   <- v025_D000.bin"
log " 0x048000 +0x1000   <- v025_48000.bin"
log " 0x0D0000 +0x1000   <- v025_D0000.bin"
log " 0x0D1000 +0x1000   <- v025_D1000.bin"
log " 0x0D2000 +0x1000   <- v025_D2000.bin"
log " 0x100000 +0x1000   <- v025_100000.bin"
log " 0x101000 +0x1000   <- v025_101000.bin"
...
ck_file v025_D000.bin aa5e1a7b10879b0c60598dce864387774b28305dad2d2f09473bcba48a29f08c
ck_file v025_48000.bin 0a1b511164cb6db2fd8a33e97fb8a5af0bedc383a92072e64c9a444578248294
ck_file v025_D0000.bin 1486610febbed13f90d63ca36f9d2f154b2364fc4d47024ffa4c7f6af05ee115
ck_file v025_D1000.bin 3431383721510cf1c211de027cf958c183e16db5fabb6b230eb284c85e196aa9
ck_file v025_D2000.bin 3431383721510cf1c211de027cf958c183e16db5fabb6b230eb284c85e196aa9
ck_file v025_100000.bin 9235a8b222f535fb17acdf729fa7b2bab7dffb89deb37ec6e3fadc6d6e154892
ck_file v025_101000.bin 3824acd00b9e61fa4abcad83a4cc08f383d74e62df29b884548dc803a0f742a5
ck_file base_D000.bin 382036913757ae6101ead97f28f9196f0407fb3874293dc9f8b88d44c26adfaf
...
ck "ptable" 53248 64 19cc7456b96f13a2978e948d63ab3f4f811d61d0b607bc972fb61e0b73be675c
ck "FIRM" 57344 1647984 239227d1a184e4e09c25683372e3d00d3604cdbcc024923988df729cbadf09f5
...
log "   grava  : 28 KiB em 7 setores"
log "   muda   : Parte A sem mexer no limite do laco: 9 objetos criados, 5 escondidos fora da tela"
...
wr "4/6 1/7" 0xD000 v025_D000.bin aa5e1a7b10879b0c60598dce864387774b28305dad2d2f09473bcba48a29f08c
wr "4/6 2/7" 0x48000 v025_48000.bin 0a1b511164cb6db2fd8a33e97fb8a5af0bedc383a92072e64c9a444578248294
wr "4/6 3/7" 0xD0000 v025_D0000.bin 1486610febbed13f90d63ca36f9d2f154b2364fc4d47024ffa4c7f6af05ee115
wr "4/6 4/7" 0xD1000 v025_D1000.bin 3431383721510cf1c211de027cf958c183e16db5fabb6b230eb284c85e196aa9
wr "4/6 5/7" 0xD2000 v025_D2000.bin 3431383721510cf1c211de027cf958c183e16db5fabb6b230eb284c85e196aa9
wr "4/6 6/7" 0x100000 v025_100000.bin 9235a8b222f535fb17acdf729fa7b2bab7dffb89deb37ec6e3fadc6d6e154892
wr "4/6 7/7" 0x101000 v025_101000.bin 3824acd00b9e61fa4abcad83a4cc08f383d74e62df29b884548dc803a0f742a5
rm -f "$WORK/sec.bin"
...
ck2 "ptable" 53248 64 2accab05221e48774f0fafb0f404a8ecb058d6fe1623127027ecfa3799b1fd01
ck2 "FIRM" 57344 1647984 69a0baaaa26c7ad5539f41bda536bf5710dd07e1b4470b0e7864264bdbcdeeef
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: V025 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_v025.log"
log ""
