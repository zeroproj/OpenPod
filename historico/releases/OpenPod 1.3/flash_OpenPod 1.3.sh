#!/bin/sh
# flash_OpenPod 1.3.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Versao em uma linha so
#
...
#
# USO   sudo sh flash_OpenPod 1.3.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_OpenPod 1.3
LOG="$WORK/flash_OpenPod 1.3.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD 1.3   (3 setores, 12 KiB)"
log " 0x1A3000 +0x1000   <- OpenPod 1.3_1A3000.bin"
log " 0x10A000 +0x1000   <- OpenPod 1.3_10A000.bin"
log " 0x121000 +0x1000   <- OpenPod 1.3_121000.bin"
...
ck_file OpenPod 1.3_1A3000.bin 8581552c3cddb65267000cb9bb34ffc663a19a281c4bc4b616e3b4c35f8905c7
ck_file OpenPod 1.3_10A000.bin 5291ec1d41be051e8677023fed65e237d2dc030d375a7a77071b384b9d4c50bf
ck_file OpenPod 1.3_121000.bin 0a9a1c3e0f0bdd9e632e7fc222b7fd84e9b54a9bd4f69d2c4141284f91b5c83c
...
log "   muda   : Versao em uma linha so"
...
wr "4/6 1/3" 0x1A3000 OpenPod 1.3_1A3000.bin 8581552c3cddb65267000cb9bb34ffc663a19a281c4bc4b616e3b4c35f8905c7
wr "4/6 2/3" 0x10A000 OpenPod 1.3_10A000.bin 5291ec1d41be051e8677023fed65e237d2dc030d375a7a77071b384b9d4c50bf
wr "4/6 3/3" 0x121000 OpenPod 1.3_121000.bin 0a9a1c3e0f0bdd9e632e7fc222b7fd84e9b54a9bd4f69d2c4141284f91b5c83c
rm -f "$WORK/sec.bin"
...
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD 1.3 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_OpenPod 1.3.log"
log ""
