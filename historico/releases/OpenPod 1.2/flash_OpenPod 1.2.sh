#!/bin/sh
# flash_OpenPod 1.2.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Titulo da tela Informacoes + carimbo automatico
#
...
#
# USO   sudo sh flash_OpenPod 1.2.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_OpenPod 1.2
LOG="$WORK/flash_OpenPod 1.2.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD 1.2   (3 setores, 12 KiB)"
log " 0x1A3000 +0x1000   <- OpenPod 1.2_1A3000.bin"
log " 0x10A000 +0x1000   <- OpenPod 1.2_10A000.bin"
log " 0x121000 +0x1000   <- OpenPod 1.2_121000.bin"
...
ck_file OpenPod 1.2_1A3000.bin f28fc8f0182eb7d5202c6e630c5bf9bab06b60c410243266e33cb7106a51604c
ck_file OpenPod 1.2_10A000.bin 5291ec1d41be051e8677023fed65e237d2dc030d375a7a77071b384b9d4c50bf
ck_file OpenPod 1.2_121000.bin 0a9a1c3e0f0bdd9e632e7fc222b7fd84e9b54a9bd4f69d2c4141284f91b5c83c
...
log "   muda   : Titulo da tela Informacoes + carimbo automatico"
...
wr "4/6 1/3" 0x1A3000 OpenPod 1.2_1A3000.bin f28fc8f0182eb7d5202c6e630c5bf9bab06b60c410243266e33cb7106a51604c
wr "4/6 2/3" 0x10A000 OpenPod 1.2_10A000.bin 5291ec1d41be051e8677023fed65e237d2dc030d375a7a77071b384b9d4c50bf
wr "4/6 3/3" 0x121000 OpenPod 1.2_121000.bin 0a9a1c3e0f0bdd9e632e7fc222b7fd84e9b54a9bd4f69d2c4141284f91b5c83c
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 cdf962c7400a8a5820c7496d8a3f5593b76921b1be9480494d4c3b0687035bf8
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD 1.2 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_OpenPod 1.2.log"
log ""
