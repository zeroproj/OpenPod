#!/bin/sh
# flash_OpenPod_1.1a.sh — OpenPod. GERADO por tools/make_install_kit.py.
...
#
# USO   sudo sh flash_OpenPod_1.1a.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_OpenPod_1.1a
LOG="$WORK/flash_OpenPod_1.1a.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD_1.1A   (3 setores, 12 KiB)"
log " 0x1A3000 +0x1000   <- OpenPod_1.1a_1A3000.bin"
log " 0x10A000 +0x1000   <- OpenPod_1.1a_10A000.bin"
log " 0x121000 +0x1000   <- OpenPod_1.1a_121000.bin"
...
ck_file OpenPod_1.1a_1A3000.bin ae3a1750e8ebe2f15ed6fd8788cc911bf58be575c1c3070bcc90952dd434d1e6
ck_file OpenPod_1.1a_10A000.bin e95316e7e6e41248907796b94ab399e1216add0aa495fcb376eece5206596c4a
ck_file OpenPod_1.1a_121000.bin 0a9a1c3e0f0bdd9e632e7fc222b7fd84e9b54a9bd4f69d2c4141284f91b5c83c
...
log "   muda   : Selecao quadrada nas listas + versao 1.1 na tela Informacoes"
...
wr "4/6 1/3" 0x1A3000 OpenPod_1.1a_1A3000.bin ae3a1750e8ebe2f15ed6fd8788cc911bf58be575c1c3070bcc90952dd434d1e6
wr "4/6 2/3" 0x10A000 OpenPod_1.1a_10A000.bin e95316e7e6e41248907796b94ab399e1216add0aa495fcb376eece5206596c4a
wr "4/6 3/3" 0x121000 OpenPod_1.1a_121000.bin 0a9a1c3e0f0bdd9e632e7fc222b7fd84e9b54a9bd4f69d2c4141284f91b5c83c
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 7ce6990770c0e69cd500cc95a642c39fc37f5c808ecc284d01b90831097b865a
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD_1.1A GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_OpenPod_1.1a.log"
log ""
