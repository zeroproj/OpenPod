#!/bin/sh
# flash_OpenPod 2.3.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Extras: msg[0x0a]=2. E um experimento de 1 byte no fundo do display.
#
...
#
# USO   sudo sh flash_OpenPod 2.3.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_OpenPod 2.3
LOG="$WORK/flash_OpenPod 2.3.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD 2.3   (3 setores, 12 KiB)"
log " 0x1A5000 +0x1000   <- OpenPod 2.3_1A5000.bin"
log " 0x10A000 +0x1000   <- OpenPod 2.3_10A000.bin"
log " 0x156000 +0x1000   <- OpenPod 2.3_156000.bin"
...
ck_file OpenPod 2.3_1A5000.bin 7a806e2250df0ed7bd99626cc89bfdd2c8fc323014df26946fc1bf64457f362d
ck_file OpenPod 2.3_10A000.bin a2c4f5c1f06a5e5e87228007a463525497aab491ff765e1194f987eec832194b
ck_file OpenPod 2.3_156000.bin 09ea275aa3916096700af353b3a9b51b3f51ab9fcad3a8ee616a504bae18d60d
ck_file base_1A5000.bin 38ceb7870b6a1bfea341f8f26dfa4bb17f1a33059ac5e6baf39c598433ecfc5e
...
ck "FIRM" 57344 1647984 3369b8d766cbc4c85485d5455b2183fa3366e92e1e5c3ae562219da6672dc743
...
log "   muda   : Extras: msg[0x0a]=2. E um experimento de 1 byte no fundo do display."
...
wr "4/6 1/3" 0x1A5000 OpenPod 2.3_1A5000.bin 7a806e2250df0ed7bd99626cc89bfdd2c8fc323014df26946fc1bf64457f362d
wr "4/6 2/3" 0x10A000 OpenPod 2.3_10A000.bin a2c4f5c1f06a5e5e87228007a463525497aab491ff765e1194f987eec832194b
wr "4/6 3/3" 0x156000 OpenPod 2.3_156000.bin 09ea275aa3916096700af353b3a9b51b3f51ab9fcad3a8ee616a504bae18d60d
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 299c1163ddfc7a4fa57ee8eb0df15cee30db6b46c3b2fa6dc186fa28372187d2
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD 2.3 GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_OpenPod 2.3.log"
log ""
