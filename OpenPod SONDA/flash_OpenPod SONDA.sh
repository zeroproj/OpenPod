#!/bin/sh
# flash_OpenPod SONDA.sh — OpenPod. GERADO por tools/make_install_kit.py.
# NAO EDITE A MAO: as constantes sao calculadas a partir das imagens.
#
# Diagnostico: o titulo do Extras mostra os campos da mensagem em hex.
#
...
#
# USO   sudo sh flash_OpenPod SONDA.sh [/opt/smartlink_flash]
...
DEV=301a:2801
WORK=$(pwd)/openpod_flash_OpenPod SONDA
LOG="$WORK/flash_OpenPod SONDA.log"
WROTE=0
...
log "======================================================================"
log " OpenPod — gravacao do OPENPOD SONDA   (2 setores, 8 KiB)"
log " 0x10A000 +0x1000   <- OpenPod SONDA_10A000.bin"
log " 0x1A5000 +0x1000   <- OpenPod SONDA_1A5000.bin"
...
ck_file OpenPod SONDA_10A000.bin 4dfdfb8597ed15256a1e364e7a52f59b51892a745ea71ae9d5e8d3215e1a299a
ck_file OpenPod SONDA_1A5000.bin 8905234994167428843eb2d8d16ee46e0c74d3a7b424a93de87a75f4187279ef
ck_file base_10A000.bin a2c4f5c1f06a5e5e87228007a463525497aab491ff765e1194f987eec832194b
ck_file base_1A5000.bin 7a806e2250df0ed7bd99626cc89bfdd2c8fc323014df26946fc1bf64457f362d
...
ck "FIRM" 57344 1647984 299c1163ddfc7a4fa57ee8eb0df15cee30db6b46c3b2fa6dc186fa28372187d2
...
log "   muda   : Diagnostico: o titulo do Extras mostra os campos da mensagem em hex."
...
wr "4/6 1/2" 0x10A000 OpenPod SONDA_10A000.bin 4dfdfb8597ed15256a1e364e7a52f59b51892a745ea71ae9d5e8d3215e1a299a
wr "4/6 2/2" 0x1A5000 OpenPod SONDA_1A5000.bin 8905234994167428843eb2d8d16ee46e0c74d3a7b424a93de87a75f4187279ef
rm -f "$WORK/sec.bin"
...
ck2 "FIRM" 57344 1647984 69a46ac6e3be030d4b8fa64b11c44b23bdd104645d48715b3322cc948452292a
ck2 "TONE" 1708032 8248 7f2882af95534ec56c6261ac14c74ddcf9a83c8deb4b5e97e333b2ee3f8b4ace

log ""
log "======================================================================"
if [ "$F" -eq 0 ]; then
    log " [6/6] RESULTADO: OPENPOD SONDA GRAVADO E VERIFICADO"
    log ""
...
log "======================================================================"
log ""
log "  leve de volta: before.bin  after.bin  flash_OpenPod SONDA.log"
log ""
