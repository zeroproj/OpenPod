...
| **13** (0x0D) | `0x101F10` | `ebook_auto_play | page13_label_process | page13_scr_process` | `0x12B8BC` | `page_ebook_read_event_cb` | sim |
| **14** (0x0E) | `0x102140` | `ebook_auto_play | page14_scr_process | pstr_page14_process` | `0x12BED4` | `page_ebook_set_scr_process` | sim |
